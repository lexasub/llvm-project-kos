...
template <typename T>
struct EnableIfFloatImpl {};
template <>
struct EnableIfFloatImpl<float> { typedef int Type; };
template <>
struct EnableIfFloatImpl<double> { typedef int Type; };
template <>
struct EnableIfFloatImpl<long double> { typedef int Type; };
template <typename T>
using EnableIfFloat = typename EnableIfFloatImpl<T>::Type;
