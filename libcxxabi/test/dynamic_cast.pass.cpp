...
struct C5 : protected virtual C3 {
  Pad2 _;
};
struct C6 : virtual C5 {
  Pad3 _;
};
struct C7 : virtual C3 {
  Pad4 _;
};
struct C9 : C6, C7 {
  Pad5 _;
...
struct Mask : protected virtual Src {
  Pad2 _;
};
struct Dest : Mask {
  Pad3 _;
};
struct Root : Dest, virtual Src {
  Pad4 _;
};
...
struct Shared : virtual Class1 {
  Pad2 _;
};
struct Class6 : virtual Shared {
  Pad3 _;
};
struct Left : Class6 {
  Pad4 _;
