...
void f9() {
  ...
  assert_cannot_catch<const volatile Base* const volatile, Ambiguous*,
                      Ambiguous>();
}
...
void f11() {
  ...
  assert_cannot_catch<const volatile Base* const volatile, Protected*,
                      Protected>();
}
...
void f12() {
  ...
  assert_cannot_catch<const Base* const volatile&, Private*, Private>();
  assert_cannot_catch<volatile Base* const volatile&, Private*, Private>();
  assert_cannot_catch<const volatile Base* const volatile&, Private*,
                      Private>();
}
