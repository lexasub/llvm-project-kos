...
isl_space_product(__isl_take isl_space *left, __isl_take isl_space *right);
...
__isl_export __isl_give isl_space *
isl_space_reverse(__isl_take isl_space *space);
__isl_export __isl_give isl_space *
isl_space_range_reverse(__isl_take isl_space *space);
...
__isl_export __isl_give isl_space *
isl_space_uncurry(__isl_take isl_space *space);
