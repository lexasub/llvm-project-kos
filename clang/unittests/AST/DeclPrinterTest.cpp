...
::testing::AssertionResult
PrintedDeclCXX11nonMSCMatches(StringRef Code,
                              const DeclarationMatcher &NodeMatch,
                              StringRef ExpectedPrinted) {
...
TEST(DeclPrinter, TestTypedef1) {
  ASSERT_TRUE(PrintedDeclCXX98Matches("typedef int A;", "A", "typedef int A"));
  // Should be: with semicolon
}

TEST(DeclPrinter, TestTypedef2) {
  ASSERT_TRUE(PrintedDeclCXX98Matches("typedef const char *A;", "A",
                                      "typedef const char *A"));
  // Should be: with semicolon
}

TEST(DeclPrinter, TestTypedef3) {
  ASSERT_TRUE(PrintedDeclCXX98Matches("template <typename Y> class X {};"
                                      "typedef X<int> A;",
                                      "A", "typedef X<int> A"));
  // Should be: with semicolon
}
...
TEST(DeclPrinter, TestTypedef4) {
  ASSERT_TRUE(PrintedDeclCXX98Matches("namespace X { class Y {}; }"
                                      "typedef X::Y A;",
                                      "A", "typedef X::Y A"));
  // Should be: with semicolon
}
...
TEST(DeclPrinter, TestNamespace1) {
  ASSERT_TRUE(PrintedDeclCXX98Matches("namespace A { int B; }", "A",
                                      "namespace A {\n}"));
  // Should be: with { ... }
}

TEST(DeclPrinter, TestNamespace2) {
  ASSERT_TRUE(PrintedDeclCXX11Matches("inline namespace A { int B; }", "A",
                                      "inline namespace A {\n}"));
  // Should be: with { ... }
}

TEST(DeclPrinter, TestNamespaceAlias1) {
  ASSERT_TRUE(PrintedDeclCXX98Matches("namespace Z { }"
                                      "namespace A = Z;",
                                      "A", "namespace A = Z"));
  // Should be: with semicolon
}
...
TEST(DeclPrinter, TestNamespaceAlias2) {
  ASSERT_TRUE(PrintedDeclCXX98Matches("namespace X { namespace Y {} }"
                                      "namespace A = X::Y;",
                                      "A", "namespace A = X::Y"));
  // Should be: with semicolon
}
...
TEST(DeclPrinter, TestCXXRecordDecl1) {
  ASSERT_TRUE(
      PrintedDeclCXX98Matches("class A { int a; };", "A", "class A {}"));
}

TEST(DeclPrinter, TestCXXRecordDecl2) {
  ASSERT_TRUE(
      PrintedDeclCXX98Matches("struct A { int a; };", "A", "struct A {}"));
}

TEST(DeclPrinter, TestCXXRecordDecl3) {
  ASSERT_TRUE(
      PrintedDeclCXX98Matches("union A { int a; };", "A", "union A {}"));
}

TEST(DeclPrinter, TestCXXRecordDecl4) {
  ASSERT_TRUE(PrintedDeclCXX98Matches("class Z { int a; };"
                                      "class A : Z { int b; };",
                                      "A", "class A : Z {}"));
}

TEST(DeclPrinter, TestCXXRecordDecl5) {
  ASSERT_TRUE(PrintedDeclCXX98Matches("struct Z { int a; };"
                                      "struct A : Z { int b; };",
                                      "A", "struct A : Z {}"));
}
...
TEST(DeclPrinter, TestCXXRecordDecl11) {
  ASSERT_TRUE(PrintedDeclCXX98Matches(
      ...
      "A", "class A : virtual public Z, private Y {}"));
}

TEST(DeclPrinter, TestFunctionDecl1) {
  ASSERT_TRUE(PrintedDeclCXX98Matches("void A();", "A", "void A()"));
}
...
TEST(DeclPrinter, TestMemberFunctionOutside_FullyQualifiedName) {
  ASSERT_TRUE(PrintedDeclCXX98Matches(
      "struct X { void A(); };"
      "void X::A() {}",
      functionDecl(hasName("A"), isDefinition()).bind("id"), "void X::A()",
      [](PrintingPolicy &Policy) { Policy.FullyQualifiedName = true; }));
}
...
TEST(DeclPrinter, TestFunctionDecl3) {
  ASSERT_TRUE(PrintedDeclCXX98Matches("void Z();"
                                      "void A() { Z(); }",
                                      "A", "void A()"));
}
...
TEST(DeclPrinter, TestFunctionDecl4) {
  ASSERT_TRUE(
      PrintedDeclCXX98Matches("extern void A();", "A", "extern void A()"));
}

TEST(DeclPrinter, TestFunctionDecl5) {
  ASSERT_TRUE(
      PrintedDeclCXX98Matches("static void A();", "A", "static void A()"));
}

TEST(DeclPrinter, TestFunctionDecl6) {
  ASSERT_TRUE(
      PrintedDeclCXX98Matches("inline void A();", "A", "inline void A()"));
}

TEST(DeclPrinter, TestFunctionDecl7) {
  ASSERT_TRUE(PrintedDeclCXX11Matches("constexpr int A(int a);", "A",
                                      "constexpr int A(int a)"));
}

TEST(DeclPrinter, TestFunctionDecl8) {
  ASSERT_TRUE(PrintedDeclCXX98Matches("void A(int a);", "A", "void A(int a)"));
}
...
TEST(DeclPrinter, TestFunctionDecl10) {
  ASSERT_TRUE(PrintedDeclCXX98Matches("void A(int a, ...);", "A",
                                      "void A(int a, ...)"));
}

TEST(DeclPrinter, TestFunctionDecl11) {
  ASSERT_TRUE(PrintedDeclCXX98Matches("typedef long ssize_t;"
                                      "typedef int *pInt;"
                                      "void A(int a, pInt b, ssize_t c);",
                                      "A", "void A(int a, pInt b, ssize_t c)"));
}

TEST(DeclPrinter, TestFunctionDecl12) {
  ASSERT_TRUE(PrintedDeclCXX98Matches("void A(int a, int b = 0);", "A",
                                      "void A(int a, int b = 0)"));
}

TEST(DeclPrinter, TestFunctionDecl13) {
  ASSERT_TRUE(PrintedDeclCXX98Matches("void (*A(int a))(int b);", "A",
                                      "void (*A(int a))(int)"));
...
TEST(DeclPrinter, TestCXXConstructorDecl1) {
  ASSERT_TRUE(PrintedDeclCXX98Matches(
      ...
      "  A();"
      "};",
      cxxConstructorDecl(ofClass(hasName("A"))).bind("id"), "A()"));
}
...
TEST(DeclPrinter, TestCXXConstructorDecl2) {
  ASSERT_TRUE(PrintedDeclCXX98Matches(
      ...
      "  A(int a);"
      "};",
      cxxConstructorDecl(ofClass(hasName("A"))).bind("id"), "A(int a)"));
}
...
TEST(DeclPrinter, TestCXXConstructorDecl3) {
  ASSERT_TRUE(PrintedDeclCXX98Matches(
      ...
      "  A(const A &a);"
      "};",
      cxxConstructorDecl(ofClass(hasName("A"))).bind("id"), "A(const A &a)"));
}
...
TEST(DeclPrinter, TestCXXConstructorDeclWithMemberInitializer_NoTerseOutput) {
  ASSERT_TRUE(PrintedDeclCXX98Matches(
      ...
      "  A() : m(2) {}"
      "};",
      cxxConstructorDecl(ofClass(hasName("A"))).bind("id"), "A() : m(2) {\n}\n",
      [](PrintingPolicy &Policy) { Policy.TerseOutput = false; }));
}
...
TEST(DeclPrinter, TestCXXConstructorDecl7) {
  ASSERT_TRUE(PrintedDeclCXX11Matches(
      ...
      "  constexpr A();"
      "};",
      cxxConstructorDecl(ofClass(hasName("A"))).bind("id"), "constexpr A()"));
}
...
TEST(DeclPrinter, TestCXXConstructorDecl8) {
  ASSERT_TRUE(PrintedDeclCXX11Matches(
      ...
      "  A() = default;"
      "};",
      cxxConstructorDecl(ofClass(hasName("A"))).bind("id"), "A() = default"));
}
...
TEST(DeclPrinter, TestCXXConstructorDecl9) {
  ASSERT_TRUE(PrintedDeclCXX11Matches(
      ...
      "  A() = delete;"
      "};",
      cxxConstructorDecl(ofClass(hasName("A"))).bind("id"), "A() = delete"));
}
...
TEST(DeclPrinter, TestCXXDestructorDecl1) {
  ASSERT_TRUE(PrintedDeclCXX98Matches(
      ...
      "  ~A();"
      "};",
      cxxDestructorDecl(ofClass(hasName("A"))).bind("id"), "~A()"));
}
...
TEST(DeclPrinter, TestCXXDestructorDecl2) {
  ASSERT_TRUE(PrintedDeclCXX98Matches(
      ...
      "  virtual ~A();"
      "};",
      cxxDestructorDecl(ofClass(hasName("A"))).bind("id"), "virtual ~A()"));
}
...
TEST(DeclPrinter, TestCXXConversionDecl1) {
  ASSERT_TRUE(PrintedDeclCXX98Matches(
      ...
      "  operator int();"
      "};",
      cxxMethodDecl(ofClass(hasName("A"))).bind("id"), "operator int()"));
}
...
TEST(DeclPrinter, TestCXXConversionDecl2) {
  ASSERT_TRUE(PrintedDeclCXX98Matches(
      ...
      "  operator bool();"
      "};",
      cxxMethodDecl(ofClass(hasName("A"))).bind("id"), "operator bool()"));
}
...
TEST(DeclPrinter, TestCXXConversionDecl3) {
  ASSERT_TRUE(PrintedDeclCXX98Matches(
      ...
      "  operator Z();"
      "};",
      cxxMethodDecl(ofClass(hasName("A"))).bind("id"), "operator Z()"));
}
...
TEST(DeclPrinter, TestCXXMethodDecl_AllocationFunction3) {
  ASSERT_TRUE(
      PrintedDeclCXX11Matches("struct Z {"
...
TEST(DeclPrinter, TestCXXMethodDecl_AllocationFunction4) {
  ASSERT_TRUE(
      PrintedDeclCXX98Matches("struct Z {"
                              "  void operator delete(void *);"
                              "};",
                              cxxMethodDecl(ofClass(hasName("Z"))).bind("id"),
                              "void operator delete(void *)"));
...
TEST(DeclPrinter, TestCXXMethodDecl_Operator1) {
  ...
  for (unsigned i = 0, e = llvm::array_lengthof(OperatorNames); i != e; ++i) {
    ...
    ASSERT_TRUE(PrintedDeclCXX98Matches(
        Code, cxxMethodDecl(ofClass(hasName("Z"))).bind("id"), Expected));
  }
}
...
TEST(DeclPrinter, TestCXXMethodDecl1) {
  ASSERT_TRUE(PrintedDeclCXX98Matches("struct Z {"
                                      "  void A(int a);"
                                      "};",
                                      "A", "void A(int a)"));
}
...
TEST(DeclPrinter, TestCXXMethodDecl_CVQualifier3) {
  ASSERT_TRUE(PrintedDeclCXX98Matches("struct Z {"
                                      ...
                                      "};",
                                      "A", "void A(int a) const volatile"));
}

TEST(DeclPrinter, TestCXXMethodDecl_RefQualifier1) {
  ASSERT_TRUE(PrintedDeclCXX11Matches("struct Z {"
                                      "  void A(int a) &;"
                                      "};",
                                      "A", "void A(int a) &"));
}
...
TEST(DeclPrinter, TestFunctionDecl_ExceptionSpecification2) {
  ASSERT_TRUE(PrintedDeclCXX98Matches("struct Z {"
                                      ...
                                      "};",
                                      "A", "void A(int a) throw(int)"));
}

TEST(DeclPrinter, TestFunctionDecl_ExceptionSpecification3) {
  ASSERT_TRUE(PrintedDeclCXX98Matches("class ZZ {};"
                                      "struct Z {"
                                      "  void A(int a) throw(ZZ, int);"
                                      "};",
                                      "A", "void A(int a) throw(ZZ, int)"));
}
...
TEST(DeclPrinter, TestFunctionDecl_ExceptionSpecification5) {
  ASSERT_TRUE(PrintedDeclCXX11Matches(
      ...
      "};",
      "A", "void A(int a) noexcept(trueA(int a) noexcept(true)"));
...
TEST(DeclPrinter, TestFunctionDecl_ExceptionSpecification6) {
  ASSERT_TRUE(PrintedDeclCXX11Matches(
      ...
      "};",
      "A", "void A(int a) noexcept(1 < 2A(int a) noexcept(1 < 2)"));
...
TEST(DeclPrinter, TestFunctionDecl_ExceptionSpecification7) {
  ASSERT_TRUE(PrintedDeclCXX11Matches(
      ...
      "};",
      "A", "void A(int a) noexcept(N < 2A(int a) noexcept(N < 2)"));
  // WRONG; Should be: "void A(int a) noexcept(N < 2);"
}

TEST(DeclPrinter, TestVarDecl1) {
  ASSERT_TRUE(PrintedDeclCXX98Matches("char *const (*(*A)[5])(int);", "A",
                                      "char *const (*(*A)[5])(int)"));
  // Should be: with semicolon
}

TEST(DeclPrinter, TestVarDecl2) {
  ASSERT_TRUE(PrintedDeclCXX98Matches("void (*A)() throw(int);", "A",
                                      "void (*A)() throw(int)"));
  // Should be: with semicolon
}

TEST(DeclPrinter, TestVarDecl3) {
  ASSERT_TRUE(PrintedDeclCXX11Matches("void (*A)() noexcept;", "A",
                                      "void (*A)() noexcept"));
  // Should be: with semicolon
}

TEST(DeclPrinter, TestFieldDecl1) {
  ASSERT_TRUE(PrintedDeclCXX98Matches("template<typename T>"
                                      "struct Z { T A; };",
                                      "A", "T A"));
  // Should be: with semicolon
}
...
TEST(DeclPrinter, TestFieldDecl2) {
  ASSERT_TRUE(PrintedDeclCXX98Matches("template<int N>"
                                      "struct Z { int A[N]; };",
                                      "A", "int A[N]"));
  // Should be: with semicolon
}
...
TEST(DeclPrinter, TestFunctionTemplateDecl4) {
  ASSERT_TRUE(
      PrintedDeclCXX98Matches("struct Z { template<typename T> void A(T t); };",
                              functionTemplateDecl(hasName("A")).bind("id"),
                              "template <typename T> void A(T t)"));
}
...
TEST(DeclPrinter, TestFunctionTemplateDecl6) {
  ASSERT_TRUE(
      PrintedDeclCXX98Matches("template<typename T >struct Z {"
...
TEST(DeclPrinter, TestTemplateArgumentList2) {
  ASSERT_TRUE(
      PrintedDeclCXX98Matches("template<typename T, typename U> struct Z {};"
                              "struct X {};"
                              "typedef int Y;"
                              "Z<X, Y> A;",
                              "A", "Z<X, Y> A"));
...
TEST(DeclPrinter, TestTemplateArgumentList4) {
  ASSERT_TRUE(PrintedDeclCXX11Matches("template<typename T> struct Z {};"
                                      "template<typename T> struct X {};"
                                      "Z<X<int>> A;",
                                      "A", "Z<X<int>> A"));
  // Should be: with semicolon
...
TEST(DeclPrinter, TestTemplateArgumentList9) {
  ASSERT_TRUE(PrintedDeclCXX98Matches("template<unsigned I> struct Z {};"
                                      "Z<0> A;",
                                      "A", "Z<0> A"));
  // Should be: with semicolon
}
...
TEST(DeclPrinter, TestTemplateArgumentList10) {
  ASSERT_TRUE(
      PrintedDeclCXX98Matches("template<unsigned I> struct Z {};"
...
TEST(DeclPrinter, TestTemplateArgumentList11) {
  ASSERT_TRUE(PrintedDeclCXX98Matches("template<int I> struct Z {};"
                                      "Z<42 * 10 - 420 / 1> A;",
                                      "A", "Z<42 * 10 - 420 / 1> A"));
  // Should be: with semicolon
}
...
TEST(DeclPrinter, TestTemplateArgumentList12) {
  ASSERT_TRUE(PrintedDeclCXX98Matches("template<const char *p> struct Z {};"
...
TEST(DeclPrinter, TestTemplateArgumentList15) {
  ASSERT_TRUE(PrintedDeclCXX11Matches("template<unsigned I> struct Z {};"
                                      "template<typename... T> struct X {"
                                      "  Z<sizeof...(T)> A;"
                                      "};",
                                      "A", "Z<sizeof...(T)> A"));
...
TEST(DeclPrinter, TestObjCMethod1) {
  ASSERT_TRUE(PrintedDeclObjCMatches(
      ...
      namedDecl(hasName("A:inRange:"),
                hasDescendant(namedDecl(hasName("printThis"))))
          .bind("id"),
      "- (int)A:(id)anObject inRange:(long)range"));
}

TEST(DeclPrinter, TestObjCProtocol1) {
  ASSERT_TRUE(PrintedDeclObjCMatches("@protocol P1, P2;",
...
TEST(DeclPrinter, TestObjCProtocol2) {
  ASSERT_TRUE(PrintedDeclObjCMatches("@protocol P2 @end"
                                     "@protocol P1<P2> @end",
                                     namedDecl(hasName("P1")).bind("id"),
                                     "@protocol P1<P2>\n@end"));
}
