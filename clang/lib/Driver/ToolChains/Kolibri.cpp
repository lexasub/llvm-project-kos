...
*/
  ...
  case llvm::Triple::x86_64: {
    ...
    Loader = X32 ? "ld-kolibri-x32.so.2" : "ld-kolibri-x86-64.so.2";
    break;
  }
    /*
case llvm::Triple::ve:
...
void Kolibri::AddClangSystemIncludeArgs(const ArgList &DriverArgs,
  ...
  const StringRef X86_64MultiarchIncludeDirs[] = {
      "/usr/include/x86_64-kolibri-gnu",

      // FIXME: These are older forms of multiarch. It's not clear that they're
      // in use in any released version of Debian, so we should consider
      // removing them.
      "/usr/include/i686-kolibri-gnu/64", "/usr/include/i486-kolibri-gnu/64"};
  const StringRef X86MultiarchIncludeDirs[] = {
      "/usr/include/i386-kolibri-gnu",
