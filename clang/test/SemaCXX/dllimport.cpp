...
#ifndef MS
namespace {
__declspec(dllimport) int InternalGlobal;
} // namespace
#endif
namespace ns {
...
#ifndef MS
namespace {
template <typename T> __declspec(dllimport) int InternalVarTmpl;
} // namespace
#endif
namespace ns {
...
namespace {
__declspec(dllimport) void internalFunc();
} // namespace
namespace ns {
...
namespace {
template <typename T> __declspec(dllimport) void internalFuncTmpl();
} // namespace
namespace ns {
...
template <typename T> struct __declspec(dllimport) PartiallySpecializedClassTemplate<T *> {
  void f() {}
};

template <typename T> struct ExpliciallySpecializedClassTemplate {};
template <> struct __declspec(dllimport) ExpliciallySpecializedClassTemplate<int> {
  void f() {}
};
