...
namespace SomeName {}     // namespace SomeName
...
void RangeTest() {
  for (auto b : R()) {
  } // expected-error {{invalid range expression of type 'R'}}
}
...
struct b0is0 {};
int g() {
  0 [sizeof(c0is0)]; // expected-error {{use of undeclared identifier}}
};
} // namespace
