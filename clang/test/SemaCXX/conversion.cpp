...
#define run_check_nullptr_13(str) \
  if (check_str_nullptr_13(str))  \
    return;
#define run_check_null_13(str) \
  if (check_str_null_13(str))  \
    return;
void function3(const char *str) {
  run_check_nullptr_13(str)
      run_check_null_13(str) if (check_str_nullptr_13(str)) return;
  if (check_str_null_13(str))
    return;
}
