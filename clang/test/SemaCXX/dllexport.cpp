...
#ifndef MS
namespace {
__declspec(dllexport) int InternalGlobal;
} // namespace
#endif
namespace ns {
...
#ifndef MS
namespace {
template <typename T> __declspec(dllexport) int InternalVarTmpl;
} // namespace
#endif
namespace ns {
...
namespace {
__declspec(dllexport) void internalFunc() {}
} // namespace
namespace ns {
...
namespace {
template <typename T> __declspec(dllexport) void internalFuncTmpl();
} // namespace
namespace ns {
...
template <typename T> struct __declspec(dllexport) PartiallySpecializedClassTemplate<T *> {
  void f() {}
};

template <typename T> struct ExpliciallySpecializedClassTemplate {};
template <> struct __declspec(dllexport) ExpliciallySpecializedClassTemplate<int> {
  void f() {}
};
...
template <> struct __declspec(dllexport) ExplicitlyExportSpecializedTemplate<int> {
  void func() {}
};
template <typename T> struct ExplicitlyImportSpecializedTemplate {
  void func() {}
};
template <> struct __declspec(dllimport) ExplicitlyImportSpecializedTemplate<int> {
  void func() {}
};
...
template <typename T> struct ExplicitlyExportInstantiatedTemplate {
  void func() {}
};
...
template <typename T> struct ExplicitlyImportInstantiatedTemplate {
  void func() {}
};
