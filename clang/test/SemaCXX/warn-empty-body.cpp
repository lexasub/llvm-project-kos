...
void test1(int x, int y) {
  while (true) {
    ...
    while (b() == 0)
      ; // expected-warning{{while loop has empty body}} expected-note{{put the semicolon on a separate line to silence this warning}}
    a(i);
    ...
    do
      ;  // expected-note{{to match this 'do'}}
