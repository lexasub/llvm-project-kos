...
template <typename T>
[[clang::speculative_load_hardening]] void ctf1();
...
[[clang::speculative_load_hardening]] void cf6();

[[clang::no_speculative_load_hardening]] void cf6(); // expected-error@-4 {{'speculative_load_hardening' and 'no_speculative_load_hardening' attributes are not compatible}} \
// expected-note@-1 {{conflicting attribute is here}}
