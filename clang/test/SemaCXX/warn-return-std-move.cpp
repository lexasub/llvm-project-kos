...
struct ConvertFromTrivialBase {
  TrivialInstrument i;
};
struct ConvertFromTrivialDerived {
  TrivialInstrument i;
};
struct TrivialBase {
  TrivialInstrument i;
...
Derived ok_lvalue1(Derived *p) {
  Derived &d = *p;
  return d;
}
Base ok_lvalue2(Derived *p) {
  Derived &d = *p;
  return d;
}
ConstructFromDerived ok_lvalue3(Derived *p) {
  const Derived &d = *p;
  return d;
}
ConstructFromBase ok_lvalue4(Derived *p) {
  Derived &d = *p;
  return d;
}
ConvertFromDerived ok_lvalue5(Derived *p) {
  Derived &d = *p;
  return d;
}
ConvertFromBase ok_lvalue6(Derived *p) {
  Derived &d = *p;
  return d;
}
...
ConstructFromDerived ok_REParam3() {
  try {
    throw_derived();
  } catch (Derived &d) {
    return d;
...
ConvertFromDerived ok_REParam5() {
  try {
    throw_derived();
  } catch (Derived &d) {
    return d;
...
ConstructFromDerived ok_CEParam3() {
  try {
    throw_derived();
  } catch (const Derived &d) {
    return d;
...
ConvertFromDerived ok_CEParam5() {
  try {
    throw_derived();
  } catch (const Derived &d) {
    return d;
...
TriviallyCopyable ok_copy1() {
  TriviallyCopyable c;
  return c;
}
OnlyCopyable ok_copy2() {
  OnlyCopyable c;
  return c;
}
