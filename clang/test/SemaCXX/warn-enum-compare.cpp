...
void test() {
  ...
  while (td == y)
    ; // expected-warning  {{comparison of different enumeration types ('TD' and 'Bar')}}
  while (td == z)
    ; // expected-warning  {{comparison of different enumeration types ('TD' and 'name1::Baz')}}
  ...
  while (z == TD2)
    ; // expected-warning  {{comparison of different enumeration types ('name1::Baz' and 'TD')}}
