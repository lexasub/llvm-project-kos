...
#define F(a, ...) A() \
#__VA_OPT__(A3 __VA_ARGS__ a##__VA_ARGS__##a##C A3) A()

18 : F() 19 : F(, ) 20 : F(, A3) 21 : F(A3, A(), A0)
...
#define F(a, ...) A() \
#__VA_OPT__(A3 __VA_ARGS__ a##__VA_ARGS__##a##C A3) a __VA_OPT__(A0 __VA_ARGS__ a##__VA_ARGS__##a##C A0) A()

                                          22 : F() 23 : F(, ) 24 : F(, A0) 25 : F(A0, A(), A0)
...
#define F(a, ...) __VA_OPT__(B a##a) \
##1
#define G(a, ...) __VA_OPT__(B a) \
##1
                                                                                    26 : F(, 1) 26_1 : G(, 1)
// CHECK: 26: B 1
// CHECK: 26_1: B 1
