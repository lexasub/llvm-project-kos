...
#pragma omp target update from(i) device(device_num \
                                         : argc + z) // expected-error {{use of undeclared identifier 'device_num'}} expected-error {{expected ')'}} expected-note {{to match this '('}}
