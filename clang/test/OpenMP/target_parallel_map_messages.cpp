...
#pragma omp target parallel map(tofrom \
                                : t[:I])
  foo();
#pragma omp target parallel map(T \
...
#pragma omp target parallel map(always, tofrom \
                                : x)
  foo();
#pragma omp target parallel map(always \
...
#pragma omp target parallel map(tofrom, always \
                                : x)
  foo();
#pragma omp target parallel map(always, tofrom \
                                : always, tofrom, x)
