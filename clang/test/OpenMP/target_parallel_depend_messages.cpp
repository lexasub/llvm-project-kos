...
#pragma omp target parallel depend(in \
                                   : argc)) // expected-warning {{extra tokens at the end of '#pragma omp target parallel' are ignored}}
  foo();
#pragma omp target parallel depend(out:) // expected-error {{expected expression}}
  foo();
#pragma omp target parallel depend(inout             \
                                   : foobool(argc)), \
  ...
  foo();
#pragma omp target parallel depend(out \
