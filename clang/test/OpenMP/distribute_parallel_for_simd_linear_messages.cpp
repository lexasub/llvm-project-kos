...
#pragma omp target
#pragma omp teams
#pragma omp distribute parallel for simd linear(B \
                                                : bfoo())
  for (int i = 0; i < 10; ++i)
    ;
...
#pragma omp target
#pragma omp teams
#pragma omp distribute parallel for simd linear(B::ib:B \
...
#pragma omp target
#pragma omp teams
#pragma omp distribute parallel for simd linear(z:B \
...
#pragma omp target
#pragma omp teams
#pragma omp distribute parallel for simd linear(X::x \
                                                : ::z)
  for (int i = 0; i < 10; ++i)
    ;
...
#pragma omp target
#pragma omp teams
#pragma omp distribute parallel for simd linear(ind2 \
...
#pragma omp target
#pragma omp teams
#pragma omp parallel for simd linear(ind2 \
...
#pragma omp target
#pragma omp teams
#pragma omp distribute parallel for simd linear(a, b \
...
#pragma omp target
#pragma omp teams
#pragma omp distribute parallel for simd linear(k \
                                                : i)
    for (k = 0; k < argc; ++k) {
      i = k;
      v += i;
...
#pragma omp target
#pragma omp teams
#pragma omp distribute parallel for simd linear(argc) allocate, allocate(, allocate(omp_default, allocate(omp_default_mem_alloc, allocate(omp_default_mem_alloc:, allocate(omp_default_mem_alloc                  \
