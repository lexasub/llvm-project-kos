...
#pragma omp target
#pragma omp teams
#pragma omp distribute simd aligned(B \
                                    : bfoo())
  for (int i = 0; i < 10; ++i)
    ;
...
#pragma omp target
#pragma omp teams
#pragma omp distribute simd aligned(B::ib:B \
...
#pragma omp target
#pragma omp teams
#pragma omp distribute simd aligned(z:B \
                                    : bfoo()) // expected-error {{unexpected ':' in nested name specifier; did you mean '::'?}}
  for (int i = 0; i < 10; ++i)
    ;
...
#pragma omp target
#pragma omp teams
#pragma omp distribute simd aligned(X::x \
...
#pragma omp target
#pragma omp teams
#pragma omp distribute simd aligned(B, rp, ::z \
...
#pragma omp target
#pragma omp teams
#pragma omp distribute simd aligned(arr \
...
#pragma omp target
#pragma omp teams
#pragma omp distribute simd aligned(ind2 \
