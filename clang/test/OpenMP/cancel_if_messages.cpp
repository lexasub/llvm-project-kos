...
#pragma omp cancel parallel if (cancel \
...
#pragma omp cancel parallel if (cancel \
                                : argc)
#pragma omp cancel parallel if (cancel \
                                : argc) if (for : argc) // expected-error {{directive name modifier 'for' is not allowed for '#pragma omp cancel'}}
#pragma omp cancel parallel if (cancel             \
                                : argc) if (cancel \
                                            : argc) // expected-error {{directive '#pragma omp cancel' cannot contain more than one 'if' clause with 'cancel' name modifier}}
#pragma omp cancel parallel if (cancel \
