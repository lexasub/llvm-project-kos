...
#pragma omp target teams distribute parallel for map(tofrom \
  ...
  for (i = 0; i < argc; ++i)
    foo();
#pragma omp target teams distribute parallel for map(T \
...
#pragma omp target teams distribute parallel for map(always, tofrom \
                                                     : x)
  for (i = 0; i < argc; ++i)
    foo();
#pragma omp target teams distribute parallel for map(always \
...
#pragma omp target teams distribute parallel for map(tofrom, always \
                                                     : x)
  for (i = 0; i < argc; ++i)
    foo();
#pragma omp target teams distribute parallel for map(always, tofrom \
