...
#pragma omp task if (task \
                     : argc)
#pragma omp task if (task \
                     : argc) if (for : argc) // expected-error {{directive name modifier 'for' is not allowed for '#pragma omp task'}}
#pragma omp task if (task             \
                     : argc) if (task \
                                 : argc) // expected-error {{directive '#pragma omp task' cannot contain more than one 'if' clause with 'task' name modifier}}
#pragma omp task if (task \
