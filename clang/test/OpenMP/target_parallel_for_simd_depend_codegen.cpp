...
#pragma omp target parallel for simd device(global + a) depend(in                   \
                                                               : global) depend(out \
                                                                                : a, b, cn[4])
  for (int i = 0; i < 10; ++i) {
  }
...
#pragma omp target parallel for simd device(global + a) nowait depend(inout                       \
...
// CHECK:       call void @__kmpc_omp_task_complete_if0(%struct.ident_t* [[IN]], i32 [[GTID]], i8* [[TASK]])
#pragma omp target parallel for simd if (0) firstprivate(global) depend(out \
                                                                        : global)
...
// CHECK:       [[RET:%.+]] = call i32 @__tgt_target_teams_mapper(%struct.ident_t* @{{.+}}, i64 [[DEVICE]], i8* @{{[^,]+}}, i32 0, i8** null, i8** null, i64* null, i64* null, i8** null, i8** null, i32 1, i32 0)
