...
#pragma omp parallel if (parallel \
                         : argc)
#pragma omp parallel if (parallel \
                         : argc) if (for : argc) // expected-error {{directive name modifier 'for' is not allowed for '#pragma omp parallel'}}
#pragma omp parallel if (parallel             \
                         : argc) if (parallel \
                                     : argc) // expected-error {{directive '#pragma omp parallel' cannot contain more than one 'if' clause with 'parallel' name modifier}}
#pragma omp parallel if (parallel \
