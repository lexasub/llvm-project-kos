...
#pragma omp target
#pragma omp teams
#pragma omp distribute simd reduction(foo \
...
#pragma omp teams
#pragma omp distribute simd reduction(^ \
                                      : z, T) // expected-error {{'T' does not refer to a value}}
  for (int i = 0; i < 10; ++i)
    foo();
#pragma omp target
#pragma omp teams
...
#pragma omp target
#pragma omp teams
#pragma omp distribute simd reduction(min \
...
#pragma omp target
#pragma omp teams
#pragma omp distribute simd reduction(max \
...
#pragma omp target
#pragma omp teams
#pragma omp distribute simd private(i), reduction(+     \
                                                  : j), \
    reduction(+                                         \
...
#pragma omp target
#pragma omp teams
#pragma omp distribute simd reduction(task, + \
                                      : fl) // omp45-error 2 {{expected expression}} omp45-warning {{missing ':' after reduction identifier - ignoring}} omp50-error 3 {{'reduction' clause with 'task' modifier allowed only on non-simd parallel or worksharing constructs}}
  for (int i = 0; i < 10; ++i)
    foo();
