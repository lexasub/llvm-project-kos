...
#pragma omp parallel sections lastprivate(argc) allocate, allocate(, allocate(omp_default, allocate(omp_default_mem_alloc, allocate(omp_default_mem_alloc:, allocate(omp_default_mem_alloc                  \
...
#pragma omp parallel sections lastprivate(conditional                        \
                                          : e, argc) lastprivate(conditional \
...
#pragma omp parallel sections lastprivate(foo \
