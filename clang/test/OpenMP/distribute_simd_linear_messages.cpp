...
#pragma omp target
#pragma omp teams
#pragma omp distribute simd linear(B \
                                   : bfoo())
  for (int i = 0; i < 10; ++i)
    ;
...
#pragma omp target
#pragma omp teams
#pragma omp distribute simd linear(B::ib:B \
...
#pragma omp target
#pragma omp teams
#pragma omp distribute simd linear(z:B \
...
#pragma omp target
#pragma omp teams
#pragma omp distribute simd linear(X::x \
                                   : ::z)
  for (int i = 0; i < 10; ++i)
    ;
...
#pragma omp target
#pragma omp teams
#pragma omp distribute simd linear(ind2 \
...
#pragma omp target
#pragma omp teams
#pragma omp distribute simd linear(a, b \
...
#pragma omp target
#pragma omp teams
#pragma omp distribute simd linear(argc) allocate, allocate(, allocate(omp_default, allocate(omp_default_mem_alloc, allocate(omp_default_mem_alloc:, allocate(omp_default_mem_alloc                  \
