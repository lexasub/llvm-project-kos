...
#pragma omp target teams distribute simd linear(B \
                                                : bfoo())
  for (int i = 0; i < 10; ++i)
    ;

// expected-error@+1 {{only loop iteration variables are allowed in 'linear' clause in distribute directives}}
#pragma omp target teams distribute simd linear(B::ib:B \
...
// expected-error@+1 {{only loop iteration variables are allowed in 'linear' clause in distribute directives}}
#pragma omp target teams distribute simd linear(z:B \
...
// expected-error@+1 {{only loop iteration variables are allowed in 'linear' clause in distribute directives}}
#pragma omp target teams distribute simd linear(X::x \
                                                : ::z)
  for (int i = 0; i < 10; ++i)
    ;
...
#pragma omp target teams distribute simd linear(ind2 \
...
#pragma omp target teams distribute simd linear(a, b \
...
// expected-error@+1 {{only loop iteration variables are allowed in 'linear' clause in distribute directives}}
#pragma omp target teams distribute simd linear(argc) allocate, allocate(, allocate(omp_default, allocate(omp_default_mem_alloc, allocate(omp_default_mem_alloc:, allocate(omp_default_mem_alloc                  \
