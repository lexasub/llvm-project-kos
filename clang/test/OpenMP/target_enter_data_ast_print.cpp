...
#pragma omp target enter data nowait map(alloc \
                                         : x [0:10], c)
...
#pragma omp target enter data nowait map(always, alloc \
                                         : e)

#pragma omp target enter data nowait depend(in                                  \
                                            : argc, argv [i:argc], x[:]) map(to \
                                                                             : i)
...
#pragma omp target enter data depend(in                                  \
                                     : argc, argv [i:argc], x[:]) map(to \
                                                                      : i) if (b) nowait
...
#pragma omp target enter data depend(in                                         \
                                     : argc, argv [i:argc], x[:]) nowait map(to \
                                                                             : a)
...
#pragma omp target enter data map(to             \
                                  : a) depend(in \
                                              : argc, argv [i:argc], x[:]) if (b > g) nowait
