...
#pragma omp target parallel if (target               \
  ...
  foo();
#pragma omp target parallel if (parallel \
                                : argc) if (for : argc) // expected-error {{directive name modifier 'for' is not allowed for '#pragma omp target parallel'}}
  foo();
#pragma omp target parallel if (target             \
                                : argc) if (target \
                                            : argc) // expected-error {{directive '#pragma omp target parallel' cannot contain more than one 'if' clause with 'target' name modifier}}
  foo();
#pragma omp target parallel if (parallel             \
                                : argc) if (parallel \
                                            : argc) // expected-error {{directive '#pragma omp target parallel' cannot contain more than one 'if' clause with 'parallel' name modifier}}
  foo();
#pragma omp target parallel if (target \
