...
#pragma omp target
#pragma omp teams distribute simd linear(B \
                                         : bfoo())
  for (int i = 0; i < 10; ++i)
    ;
...
// expected-error@+2 {{only loop iteration variables are allowed in 'linear' clause in distribute directives}}
#pragma omp target
#pragma omp teams distribute simd linear(B::ib:B \
...
// expected-error@+2 {{only loop iteration variables are allowed in 'linear' clause in distribute directives}}
#pragma omp target
#pragma omp teams distribute simd linear(z:B \
...
// expected-error@+2 {{only loop iteration variables are allowed in 'linear' clause in distribute directives}}
#pragma omp target
#pragma omp teams distribute simd linear(X::x \
                                         : ::z)
  for (int i = 0; i < 10; ++i)
    ;
...
#pragma omp target
#pragma omp teams distribute simd linear(ind2 \
...
// expected-error@+2 {{only loop iteration variables are allowed in 'linear' clause in distribute directives}}
#pragma omp target
#pragma omp teams distribute simd linear(argc : 5) allocate, allocate(, allocate(omp_default, allocate(omp_default_mem_alloc, allocate(omp_default_mem_alloc:, allocate(omp_default_mem_alloc                  \
...
#pragma omp target
#pragma omp teams distribute simd linear(a, b \
