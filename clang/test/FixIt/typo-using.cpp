...
public:
  typedef int AAA;
}; // expected-note {{'AAA' declared here}}
class DDD : public CCC {
public:
  using CCC::AAB;
}; // expected-error {{no member named 'AAB' in 'using_suggestion_member_ty::CCC'; did you mean 'AAA'?}}
} // namespace using_suggestion_member_ty
...
public:
  using CCC::AAB;
}; // expected-error {{no member named 'AAB' in 'using_suggestion_member_val::CCC'; did you mean 'AAA'?}}
} // namespace using_suggestion_member_val
...
class DDD : public CCC {
public:
  using typename CCC::AAB;
}; // expected-error {{no member named 'AAB' in 'using_suggestion_member_tyname_ty::CCC'; did you mean 'AAA'?}}
} // namespace using_suggestion_member_tyname_ty
