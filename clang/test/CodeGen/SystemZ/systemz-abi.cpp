...
class agg_float_class {
  float a;
};
class agg_float_class pass_agg_float_class(class agg_float_class arg) {
  return arg;
}
...
struct agg_float_cpp pass_agg_float_cpp(struct agg_float_cpp arg) {
  return arg;
}
...
struct agg_float_empty {
  float a;
  [[no_unique_address]] empty dummy;
};
...
struct agg_nofloat_emptyarray {
  float a;
  [[no_unique_address]] empty dummy[3];
};
struct agg_nofloat_emptyarray pass_agg_nofloat_emptyarray(struct agg_nofloat_emptyarray arg) {
  return arg;
}
...
struct agg_nofloat_emptybase : noemptybase {
  float a;
};
struct agg_nofloat_emptybase pass_agg_nofloat_emptybase(struct agg_nofloat_emptybase arg) {
  return arg;
}
...
struct agg_float_emptybase : emptybase {
  float a;
};
struct agg_float_emptybase pass_agg_float_emptybase(struct agg_float_emptybase arg) {
  return arg;
}
...
struct noemptybasearray {
  [[no_unique_address]] empty dummy[3];
};
struct agg_nofloat_emptybasearray : noemptybasearray {
  float a;
};
struct agg_nofloat_emptybasearray pass_agg_nofloat_emptybasearray(struct agg_nofloat_emptybasearray arg) {
  return arg;
}
