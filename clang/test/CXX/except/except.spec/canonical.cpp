...
public:
  ...
  basic_string() noexcept(_is_nothrow_constructible<allocator_type>::value);
};

template <class, class, class _Compare>
struct __map_value_compare {
public:
  __map_value_compare() noexcept(_is_nothrow_constructible<_Compare>::value);
};
...
__map_value_compare<T, Value, _Compare>::__map_value_compare() noexcept(_is_nothrow_constructible<_Compare>::value) {}
