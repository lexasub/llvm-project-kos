...
template <typename T> enum A<T>::E : T { e1,
                                         e2 }; // expected-note 2 {{declared here}}
...
template <typename T> enum class B<T>::E { e1,
                                           e2 };
...
template <> enum A<long long>::E : long long { e3,
                                               e4 }; // expected-error {{explicit specialization of 'E' after instantiation}} expected-note {{first required here}}

template <> enum class B<long long>::E { e3,
                                         e4 };
...
template <> enum class C<long long>::E : long long { e3,
                                                     e4 };
