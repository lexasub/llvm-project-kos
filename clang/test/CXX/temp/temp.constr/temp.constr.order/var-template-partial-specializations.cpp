...
template <typename T> requires C1<T> bool b = false;

template <typename T> requires(C1<T> && sizeof(T) <= 10) bool b<T> = true;
...
template <typename T> requires C1<T> bool c<T> = true;
...
template <typename T> requires C1<T> bool e = false;
...
template <typename T> requires C1<T> &&C2<T> constexpr int f<T> = 2;

template <typename T> requires C1<T> || C2<T> constexpr int f<T> = 3;
