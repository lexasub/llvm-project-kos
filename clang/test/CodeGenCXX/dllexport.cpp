...
namespace ns {
__declspec(dllexport) int ExternalGlobal;
}
...
namespace ns {
template <typename T> __declspec(dllexport) int ExternalVarTmpl = 1;
}
...
namespace ns {
__declspec(dllexport) void externalFunc() {}
} // namespace ns
...
namespace ns {
template <typename T> __declspec(dllexport) void externalFuncTmpl() {}
} // namespace ns
...
template <typename T> struct __declspec(dllexport) U {
  void foo() {}
};
...
template <typename T> struct PartiallySpecializedExportedClassTemplate<T *> {
  void f() {}
};
...
template <typename T> struct __declspec(dllimport) ExplicitlyInstantiatedWithDifferentAttr {
  void f() {}
};
...
template <typename T> struct ExplicitInstantiationDeclExportedDefTemplate {
  void f() {}
  ExplicitInstantiationDeclExportedDefTemplate() {}
};
...
template <typename T> struct ImplicitInstantiationExportedExplicitInstantiationDefTemplate {
  virtual void f() {}
};
...
template <typename T> struct __declspec(dllexport) ImplicitInstantiationExplicitInstantiationDefExportedTemplate {
  virtual void f() {}
};
...
template <typename T> struct __declspec(dllexport) ImplicitInstantiationExportedExplicitInstantiationDefExportedTemplate {
  virtual void f() {}
};
...
template <typename T> struct PR42857 {
  __declspec(dllexport) PR42857() = default;
  Qux q;
};
...
template <typename T> struct ExplicitInstantiationTwoAttributes {
  void f() {}
};
