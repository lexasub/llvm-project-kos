...
__attribute__((optnone)) inline int func1(int a) {
  return a + a + a + a;
}
// CHECK: @_Z5func1i({{.*}}) [[OPTNONE:#[0-9]+]]

// optnone declaration, inlinehint definition.
__attribute__((optnone)) int func2(int a);
...
__attribute__((optnone)) int func3(int a);

__attribute__((minsize)) int func3(int a) {
  return a + a + a + a;
}
...
__attribute__((noreturn)) extern void exit_from_function();

__attribute__((noreturn)) __attribute((optnone)) extern void noreturn_function(int a) { exit_from_function(); }
// CHECK: @_Z17noreturn_functioni({{.*}}) [[NORETURN:#[0-9]+]]

// Verify that __declspec(noinline) is compatible with optnone.
__declspec(noinline) __attribute__((optnone)) void func4() { return; }
// CHECK: @_Z5func4v() [[OPTNONE]]

__declspec(noinline) extern void func5();

__attribute__((optnone)) void func5() { return; }
...
imported_optnone_func(int a);

__attribute__((dllexport))
__attribute__((optnone)) int
exported_optnone_func(int a) {
