...
struct paddedpackednested {
  struct paddedpacked p1, p2;
};
...
struct bitfieldaligned {
  int i : 4;
  int : 0;
  int j : 2;
};
struct big {
  unsigned a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z;
};
...
struct semivolatileinit {
  int i = 0x11111111;
  volatile int vi = 0x11111111;
};
