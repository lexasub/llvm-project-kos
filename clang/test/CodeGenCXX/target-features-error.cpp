...
struct S {
  __attribute__((always_inline, target("avx512f"))) void foo() {}
  __attribute__((always_inline, target("avx512f")))
  operator int() { return 0; }
  __attribute__((always_inline, target("avx512f"))) void operator()() {}
};
__attribute__((always_inline, target("avx512f"))) void free_func() {}
...
#ifdef TEST2
__attribute__((target("avx512f"))) void usage(S &s) {
  s.foo();
  (void)(int) s;
  s();
