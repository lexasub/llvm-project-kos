...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *Data, size_t Size) {
  if (Size >= 20 && Data[0] == 'F' && Data[1] == 'U' && Data[2] == 'Z' && Data[3] == 'Z' && Func1(Data, Size) && Func2(Data, Size)) {
...
extern "C"
    ...
    Func1(const uint8_t *Data, size_t Size) {
...
extern "C"
    __attribute__((noinline)) bool
    Func2(const uint8_t *Data, size_t Size) {
