...
void *breakpoint_func(void *input) {
...
void *watchpoint_func(void *input) {
  pseudo_barrier_wait(g_barrier);
  do_action_args(input);
...
void start_threads(thread_vector &threads, action_counts &actions,
                   void *args = 0) {
