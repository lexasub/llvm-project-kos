...
// First we have some simple functions that return standard types, ints, floats
// and doubles. We have a function calling a function in a few cases to test
// that if you stop in the inner function then do "up/fin" you get the return
// value from the outer-most frame.

int inner_sint(int value) { return value; }

int outer_sint(int value) {
  int outer_value = 2 * inner_sint(value);
  return outer_value;
}

float inner_float(float value) { return value; }

float outer_float(float value) {
...
char *return_pointer(char *value) { return value; }

struct one_int {
  int one_field;
};

struct one_int return_one_int(struct one_int value) {
  return value;
}
...
struct two_int return_two_int(struct two_int value) {
  return value;
}
...
struct three_int return_three_int(struct three_int value) {
  return value;
}
...
struct four_int return_four_int(struct four_int value) {
  return value;
}
...
struct five_int return_five_int(struct five_int value) {
  return value;
}
...
struct one_short_one_double_one_short return_one_short_one_double_one_short(
    struct one_short_one_double_one_short value) {
  return value;
}
...
struct two_double return_two_double(struct two_double value) {
  return value;
}
...
struct two_float return_two_float(struct two_float value) {
  return value;
}
...
struct one_int_one_long return_one_int_one_long(struct one_int_one_long value) {
  return value;
}
...
struct one_pointer return_one_pointer(struct one_pointer value) {
  return value;
}
...
struct two_pointer return_two_pointer(struct two_pointer value) {
  return value;
}
...
return_double_nested_one_float_one_nested(
    struct double_nested_one_float_one_nested value) {
  return value;
}
...
base_class_one_char return_base_class_one_char(base_class_one_char value) {
  return value;
}
...
base_class return_base_class(base_class value) { return value; }
...
sub_class return_sub_class(sub_class value) { return value; }
...
derived_class return_derived_class(derived_class value) { return value; }
...
int main() {
  ...
  return_one_int_one_float_one_int(
      (struct one_int_one_float_one_int){10, 20.0, 30});
  ...
  return_one_float_one_pointer(
      (struct one_float_one_pointer){10.0, g_first_pointer});
  return_one_int_one_pointer((struct one_int_one_pointer){10, g_first_pointer});
  return_three_short_one_float(
      (struct three_short_one_float){10, 20, 30, 40.0});

  return_one_int_one_double((struct one_int_one_double){10, 20.0});
  return_one_int_one_double_one_int(
      (struct one_int_one_double_one_int){10, 20.0, 30});
  return_one_short_one_double_one_short(
      (struct one_short_one_double_one_short){10, 20.0, 30});
  return_one_float_one_int_one_float(
      (struct one_float_one_int_one_float){10.0, 20, 30.0});
  return_two_float((struct two_float){10.0, 20.0});
  return_one_int_one_double_packed(
      (struct one_int_one_double_packed){10, 20.0});
  ...
  return_nested_one_float_three_base((struct nested_one_float_three_base){
      10.0, (struct base_one_char){'x'}, (struct base_one_char){'y'},
      (struct base_one_char){'z'}});
  return_double_nested_one_float_one_nested(
      (struct double_nested_one_float_one_nested){
          10.0, (struct nested_one_float_three_base){
                    20.0, (struct base_one_char){'x'},
                    (struct base_one_char){'y'}, (struct base_one_char){'z'}}});
  return_nested_float_struct((struct nested_float_struct){
      10.0, (struct base_float_struct){20.0, 30.0}});
  ...
  return_vector_size_float32_16(
      (vector_size_float32_16){1.5, 2.25, 4.125, 8.0625});
  return_vector_size_float32_32((vector_size_float32_32){
      1.5, 2.25, 4.125, 8.0625, 7.89, 8.52, 6.31, 9.12});

  return_ext_vector_size_float32_2((ext_vector_size_float32_2){16.5, 32.25});
  return_ext_vector_size_float32_4(
      (ext_vector_size_float32_4){16.5, 32.25, 64.125, 128.0625});
  return_ext_vector_size_float32_8((ext_vector_size_float32_8){
      16.5, 32.25, 64.125, 128.0625, 1.59, 3.57, 8.63, 9.12});
