...
// T_VALUE_1 defined to a valid initializer value for TEST_TYPE (7 for int, 2.0
// for float) T_VALUE_2, T_VALUE_3, T_VALUE_4 defined to a valid initializer
// value for TEST_TYPE that is different from TEST_VALUE_1 T_PRINTF_FORMAT
...
class a_class {
public:
  a_class(const T &a, const T &b) : m_a(a), m_b(b) {}

  ~a_class() {}

  const T &get_a() const { return m_a; }

  void set_a(const T &a) { m_a = a; }

  const T &get_b() const { return m_b; }

  void set_b(const T &b) { m_b = b; }
...
int main(int argc, char const *argv[]) {
  ...
  fprintf(out,
          "(a_class*) a_class_ptr = %p, a_class_ptr->m_a = '" T_PRINTF_FORMAT
          "'\n",
          a_class_ptr, a_class_ptr->get_a());
  fprintf(out,
          "(a_class*) a_class_ptr = %p, a_class_ptr->m_b = '" T_PRINTF_FORMAT
          "'\n",
          a_class_ptr, a_class_ptr->get_b());
  fprintf(out,
          "(a_class&) a_class_ref = %p, a_class_ref.m_a = '" T_PRINTF_FORMAT
          "'\n",
          &a_class_ref, a_class_ref.get_a());
  fprintf(out,
          "(a_class&) a_class_ref = %p, a_class_ref.m_b = '" T_PRINTF_FORMAT
          "'\n",
  ...
  fprintf(out,
          "(a_struct_t*) a_struct_ptr = %p, a_struct_ptr->a = '" T_PRINTF_FORMAT
          "'\n",
          a_struct_ptr, a_struct_ptr->a);
  fprintf(out,
          "(a_struct_t*) a_struct_ptr = %p, a_struct_ptr->b = '" T_PRINTF_FORMAT
          "'\n",
          a_struct_ptr, a_struct_ptr->b);
  fprintf(out,
          "(a_struct_t&) a_struct_ref = %p, a_struct_ref.a = '" T_PRINTF_FORMAT
          "'\n",
          &a_struct_ref, a_struct_ref.a);
  fprintf(out,
          "(a_struct_t&) a_struct_ref = %p, a_struct_ref.b = '" T_PRINTF_FORMAT
          "'\n",
  ...
  fprintf(out, "(a_union_zero_t) a_union_zero.a = '" T_PRINTF_FORMAT "'\n",
          a_union_zero.a);
  fprintf(out,
          "(a_union_zero_t*) a_union_zero_ptr = %p, a_union_zero_ptr->a = "
          "'" T_PRINTF_FORMAT "'\n",
          a_union_zero_ptr, a_union_zero_ptr->a);
  fprintf(out,
          "(a_union_zero_t&) a_union_zero_ref = %p, a_union_zero_ref.a = "
          "'" T_PRINTF_FORMAT "'\n",
          &a_union_zero_ref, a_union_zero_ref.a);

  fprintf(out,
          "(a_union_nonzero_t) a_union_nonzero.u.a = '" T_PRINTF_FORMAT "'\n",
          a_union_nonzero.u.a);
  fprintf(out,
          "(a_union_nonzero_t*) a_union_nonzero_ptr = %p, "
          "a_union_nonzero_ptr->u.a = '" T_PRINTF_FORMAT "'\n",
          a_union_nonzero_ptr, a_union_nonzero_ptr->u.a);
  fprintf(out,
          "(a_union_nonzero_t&) a_union_nonzero_ref = %p, "
          "a_union_nonzero_ref.u.a = '" T_PRINTF_FORMAT "'\n",
          &a_union_nonzero_ref, a_union_nonzero_ref.u.a);

  fprintf(out,
          "(a_struct_t[2]) a_struct_array_bounded[0].a = '" T_PRINTF_FORMAT
          "'\n",
          a_struct_array_bounded[0].a);
  fprintf(out,
          "(a_struct_t[2]) a_struct_array_bounded[0].b = '" T_PRINTF_FORMAT
          "'\n",
          a_struct_array_bounded[0].b);
  fprintf(out,
          "(a_struct_t[2]) a_struct_array_bounded[1].a = '" T_PRINTF_FORMAT
          "'\n",
          a_struct_array_bounded[1].a);
  fprintf(out,
          "(a_struct_t[2]) a_struct_array_bounded[1].b = '" T_PRINTF_FORMAT
          "'\n",
          a_struct_array_bounded[1].b);

  fprintf(out,
          "(a_struct_t[]) a_struct_array_unbounded[0].a = '" T_PRINTF_FORMAT
          "'\n",
          a_struct_array_unbounded[0].a);
  fprintf(out,
          "(a_struct_t[]) a_struct_array_unbounded[0].b = '" T_PRINTF_FORMAT
          "'\n",
          a_struct_array_unbounded[0].b);
  fprintf(out,
          "(a_struct_t[]) a_struct_array_unbounded[1].a = '" T_PRINTF_FORMAT
          "'\n",
          a_struct_array_unbounded[1].a);
  fprintf(out,
          "(a_struct_t[]) a_struct_array_unbounded[1].b = '" T_PRINTF_FORMAT
          "'\n",
          a_struct_array_unbounded[1].b);

  fprintf(
      out,
      "(a_union_zero_t[2]) a_union_zero_array_bounded[0].a = '" T_PRINTF_FORMAT
      "'\n",
      a_union_zero_array_bounded[0].a);
  fprintf(
      out,
      "(a_union_zero_t[2]) a_union_zero_array_bounded[1].a = '" T_PRINTF_FORMAT
      "'\n",
      a_union_zero_array_bounded[1].a);

  fprintf(
      out,
      "(a_union_zero_t[]) a_union_zero_array_unbounded[0].a = '" T_PRINTF_FORMAT
      "'\n",
      a_union_zero_array_unbounded[0].a);
  fprintf(
      out,
      "(a_union_zero_t[]) a_union_zero_array_unbounded[1].a = '" T_PRINTF_FORMAT
      "'\n",
      a_union_zero_array_unbounded[1].a);

#endif
  puts("About to exit, break here to check values..."); // Here is the line we
                                                        // will break on to
                                                        // check variables.
