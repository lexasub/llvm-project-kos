...
void do_bad_thing_with_location(unsigned index, char *char_ptr, char new_val) {
...
uint32_t access_pool(bool flag = false) {
...
void thread_func(uint32_t thread_index) {
  ...
  while (count++ < 15) {
    ...
    printf(
        "%s (thread = %u) after sleep access_pool returns %d (count=%d)...\n",
