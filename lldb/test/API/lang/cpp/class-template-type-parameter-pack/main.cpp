...
template <typename T, typename...> struct AnonTypePackAfterTypeParam { T c; };
...
template <typename, typename...> struct AnonTypePackAfterAnonTypeParam {
  float d;
};
AnonTypePackAfterAnonTypeParam<int> emptyAnonTypePackAfterAnonTypeParam;
AnonTypePackAfterAnonTypeParam<int, float>
    oneElemAnonTypePackAfterAnonTypeParam;

// Named type parameter pack behind an unnamed type parameter.
template <typename, typename... Ts> struct TypePackAfterAnonTypeParam {
  int e;
};
...
template <typename T, typename... Ts> struct TypePackAfterTypeParam { int f; };
TypePackAfterTypeParam<int> emptyTypePackAfterTypeParam;
TypePackAfterTypeParam<int, float> oneElemTypePackAfterTypeParam;

// Test type parameter packs combined with non-pack non-type template
// parameters.

// Unnamed type parameter pack behind a named type parameter.
template <int I, typename...> struct AnonTypePackAfterNonTypeParam { int g; };
...
// Unnamed type parameter pack behind an unnamed type parameter.
template <int, typename...> struct AnonTypePackAfterAnonNonTypeParam {
  float h;
};
AnonTypePackAfterAnonNonTypeParam<1> emptyAnonTypePackAfterAnonNonTypeParam;
AnonTypePackAfterAnonNonTypeParam<1, int>
    oneElemAnonTypePackAfterAnonNonTypeParam;

// Named type parameter pack behind an unnamed type parameter.
template <int, typename... Ts> struct TypePackAfterAnonNonTypeParam { int i; };
...
// Named type parameter pack behind an unnamed type parameter.
template <int I, typename... Ts> struct TypePackAfterNonTypeParam { int j; };
