...
int main(int argc, char const *argv[]) {
  ...
  return the_char - the_signed_char + the_short - the_signed_short + the_int -
         the_signed_int + the_long - the_signed_long + the_long_long -
         the_signed_long_long; //// break $source:$line; c
                               //// var the_int
                               //// val -set 22 1
}
