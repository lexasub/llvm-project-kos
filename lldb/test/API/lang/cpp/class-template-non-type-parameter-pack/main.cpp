...
template <int... Is> struct NonTypePack { int a; };
...
template <int...> struct AnonNonTypePack { int b; };
...
template <typename T, int...> struct AnonNonTypePackAfterTypeParam { T c; };
...
template <typename T, int... Is> struct NonTypePackAfterTypeParam { int f; };
...
// Test non-type parameter packs combined with non-pack non-type template
// parameters.

// Unnamed non-type parameter pack behind a named non-type parameter.
template <int I, int...> struct AnonNonTypePackAfterNonTypeParam { int g; };
...
template <int, int...> struct AnonNonTypePackAfterAnonNonTypeParam { float h; };
AnonNonTypePackAfterAnonNonTypeParam<1>
    emptyAnonNonTypePackAfterAnonNonTypeParam;
AnonNonTypePackAfterAnonNonTypeParam<1, 2>
    oneElemAnonNonTypePackAfterAnonNonTypeParam;

// Named non-type parameter pack behind an unnamed non-type parameter.
template <int, int... Is> struct NonTypePackAfterAnonNonTypeParam { int i; };
...
// Named non-type parameter pack behind an unnamed non-type parameter.
template <int I, int... Is> struct NonTypePackAfterNonTypeParam { int j; };
