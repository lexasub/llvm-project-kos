...
public:
  B(int b_value, int a_value)
      : Extra(b_value, a_value), A(a_value), m_b_value(b_value) {}
  B(int b_value, int a_value, A *client_A)
      : Extra(b_value, a_value), A(a_value, client_A), m_b_value(b_value) {}
...
int main(int argc, char **argv) {
  ...
  myB.doSomething(
      otherB); // Break here and get real addresses of myB and otherB.
