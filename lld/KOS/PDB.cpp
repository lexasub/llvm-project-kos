...
Timer lld::kos::loadGHashTimer("Global Type Hashing", addObjectsTimer);
Timer lld::kos::mergeGHashTimer("GHash Type Merging", addObjectsTimer);
...
lld::kos::getFileLineCodeView(const SectionChunk *c, uint32_t addr) {
  ExitOnError exitOnErr;
