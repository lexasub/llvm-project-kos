...
TpiSource *lld::kos::makeTpiSource(ObjFile *file) {
  return make<TpiSource>(TpiSource::Regular, file);
}

TpiSource *lld::kos::makeTypeServerSource(PDBInputFile *pdbInputFile) {
...
TpiSource *lld::kos::makePrecompSource(ObjFile *file) {
