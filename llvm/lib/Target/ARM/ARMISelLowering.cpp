...
SDValue ARMTargetLowering::LowerOperation(SDValue Op, SelectionDAG &DAG) const {
  ...
  case ISD::TRUNCATE:
    return LowerTruncatei1(Op, DAG, Subtarget);
