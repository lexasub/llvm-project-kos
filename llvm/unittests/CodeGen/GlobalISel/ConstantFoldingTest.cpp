...
TEST_F(AArch64GISelMITest, FoldBinOp) {
  ...
  Optional<APInt> FoldGAddInt = ConstantFoldBinOp(
  ...
  Optional<APInt> FoldGAddMix = ConstantFoldBinOp(
  ...
  Optional<APInt> FoldGAndInt = ConstantFoldBinOp(
  ...
  Optional<APInt> FoldGAndMix = ConstantFoldBinOp(
  ...
  Optional<APInt> FoldGAShrInt = ConstantFoldBinOp(
  ...
  Optional<APInt> FoldGAShrMix = ConstantFoldBinOp(
  ...
  Optional<APInt> FoldGLShrInt = ConstantFoldBinOp(
  ...
  Optional<APInt> FoldGLShrMix = ConstantFoldBinOp(
  ...
  Optional<APInt> FoldGMulInt = ConstantFoldBinOp(
  ...
  Optional<APInt> FoldGMulMix = ConstantFoldBinOp(
  ...
  Optional<APInt> FoldGOrInt = ConstantFoldBinOp(
  ...
  Optional<APInt> FoldGOrMix = ConstantFoldBinOp(
  ...
  Optional<APInt> FoldGShlInt = ConstantFoldBinOp(
  ...
  Optional<APInt> FoldGShlMix = ConstantFoldBinOp(
  ...
  Optional<APInt> FoldGSubInt = ConstantFoldBinOp(
  ...
  Optional<APInt> FoldGSubMix = ConstantFoldBinOp(
  ...
  Optional<APInt> FoldGXorInt = ConstantFoldBinOp(
  ...
  Optional<APInt> FoldGXorMix = ConstantFoldBinOp(
  ...
  Optional<APInt> FoldGUdivInt = ConstantFoldBinOp(
  ...
  Optional<APInt> FoldGUdivMix = ConstantFoldBinOp(
  ...
  Optional<APInt> FoldGSdivInt = ConstantFoldBinOp(
  ...
  Optional<APInt> FoldGSdivMix = ConstantFoldBinOp(
  ...
  Optional<APInt> FoldGUremInt = ConstantFoldBinOp(
      TargetOpcode::G_UDIV, MIBCst1.getReg(0), MIBCst2.getReg(0), *MRI);
  EXPECT_TRUE(FoldGUremInt.hasValue());
  EXPECT_EQ(1ULL, FoldGUremInt.getValue().getLimitedValue());
  Optional<APInt> FoldGUremMix = ConstantFoldBinOp(
      TargetOpcode::G_UDIV, MIBCst1.getReg(0), MIBFCst2.getReg(0), *MRI);
  ...
  Optional<APInt> FoldGSremInt = ConstantFoldBinOp(
  ...
  Optional<APInt> FoldGSremMix = ConstantFoldBinOp(
