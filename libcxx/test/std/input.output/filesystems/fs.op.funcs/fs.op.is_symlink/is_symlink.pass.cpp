...
TEST_CASE(is_symlink_status_test) {
  ...
  const TestCase testCases[] = {
      {file_type::none, false},      {file_type::not_found, false},
      {file_type::regular, false},   {file_type::directory, false},
      {file_type::symlink, true},    {file_type::block, false},
      {file_type::character, false}, {file_type::fifo, false},
      {file_type::socket, false},    {file_type::unknown, false}};
...
TEST_CASE(static_env_test) {
  ...
  const TestCase testCases[] = {{static_env.File, false},
