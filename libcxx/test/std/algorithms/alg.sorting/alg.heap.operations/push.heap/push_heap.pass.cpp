...
TEST_CONSTEXPR_CXX20 bool test() {
  ...
  {
    T input[] = {1, 3, 2, 5, 4};
    std::push_heap(Iter(input), Iter(input + 1));
    assert(input[0] == 1);
    std::push_heap(Iter(input), Iter(input + 2));
    assert(input[0] == 3);
    std::push_heap(Iter(input), Iter(input + 3));
    assert(input[0] == 3);
    std::push_heap(Iter(input), Iter(input + 4));
    assert(input[0] == 5);
    std::push_heap(Iter(input), Iter(input + 5));
    assert(input[0] == 5);
