...
TEST_CONSTEXPR_CXX20 bool test() {
...

  {
    ...
    std::pop_heap(Iter(input), Iter(input + 5));
    assert(input[4] == 5);
    std::pop_heap(Iter(input), Iter(input + 4));
    assert(input[3] == 4);
    std::pop_heap(Iter(input), Iter(input + 3));
    assert(input[2] == 3);
    std::pop_heap(Iter(input), Iter(input + 2));
    assert(input[1] == 2);
    std::pop_heap(Iter(input), Iter(input + 1));
    assert(input[0] == 1);
  }
  return true;
}
