...
TEST_CONSTEXPR_CXX20 bool test() {
  ...
  (void)std::partition_copy(t.data, t.data + 5, u.data, u.data + 5,
                            [](void*) { return true; });
  ...
  (void)std::remove_copy_if(t.data, t.data + 10, u.data,
                            [](void*) { return true; });
  ...
  (void)std::replace_copy_if(
      t.data, t.data + 10, u.data, [](void*) { return true; }, value);
  (void)std::replace_if(
      t.data, t.data + 10, [](void*) { return true; }, value);
  (void)std::reverse_copy(t.data, t.data + 10, u.data);
  (void)std::rotate_copy(t.data, t.data + 5, t.data + 10, u.data);
  // TODO: shift_left
  // TODO: shift_right
  (void)std::transform(t.data, t.data + 10, u.data,
                       [](void*) { return nullptr; });
  ...
  (void)std::set_difference(t.data, t.data + 5, t.data + 5, t.data + 10,
                            u.data);
  (void)std::set_intersection(t.data, t.data + 5, t.data + 5, t.data + 10,
                              u.data);
  (void)std::set_symmetric_difference(t.data, t.data + 5, t.data + 5,
                                      t.data + 10, u.data);
  ...
  (void)std::set_difference(t.data, t.data + 5, t.data + 5, t.data + 10, u.data,
                            std::less<void*>());
  (void)std::set_intersection(t.data, t.data + 5, t.data + 5, t.data + 10,
                              u.data, std::less<void*>());
  (void)std::set_symmetric_difference(t.data, t.data + 5, t.data + 5,
                                      t.data + 10, u.data, std::less<void*>());
  (void)std::set_union(t.data, t.data + 5, t.data + 5, t.data + 10, u.data,
                       std::less<void*>());
