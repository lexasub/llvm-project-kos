...
TEST_CONSTEXPR bool test_constexpr() {
  ...
  return !std::equal(std::begin(ia), std::end(ia), std::begin(ic), eq) &&
         ...
         && std::equal(II(std::begin(ib)), II(std::end(ib)), II(std::begin(ic)),
                       eq) &&
         !std::equal(BI(std::begin(ib)), BI(std::end(ib)), BI(std::begin(ic)),
                     BI(std::end(ic)), eq);
}
#endif
...
int main(int, char**) {
  ...
  assert(std::equal(input_iterator<const int*>(ia),
                    ...
                    input_iterator<const int*>(ia), std::equal_to<int>()));
#if TEST_STD_VER >= 14
  assert(std::equal(input_iterator<const int*>(ia),
                    input_iterator<const int*>(ia + s),
                    input_iterator<const int*>(ia),
                    input_iterator<const int*>(ia + s), std::equal_to<int>()));
  ...
  comparison_count = 0;
  assert(!std::equal(
      input_iterator<const int*>(ia), input_iterator<const int*>(ia + s),
      input_iterator<const int*>(ia), input_iterator<const int*>(ia + s - 1),
      counting_equals<int>));
  ...
  assert(!std::equal(input_iterator<const int*>(ia),
                     input_iterator<const int*>(ia + s),
                     input_iterator<const int*>(ib), std::equal_to<int>()));
#if TEST_STD_VER >= 14
  assert(!std::equal(input_iterator<const int*>(ia),
                     input_iterator<const int*>(ia + s),
                     input_iterator<const int*>(ib),
                     input_iterator<const int*>(ib + s), std::equal_to<int>()));
  assert(!std::equal(random_access_iterator<const int*>(ia),
                     random_access_iterator<const int*>(ia + s),
