...
int main(int, char**) {
  {
    ...
    std::multimap
        m; // expected-error{{no viable constructor or deduction guide for deduction of template arguments of 'multimap'}}
  }
  {
  ...
  }
  {
    ...
    NotAnAllocator a;
    std::multimap m(
        a); // expected-error{{no viable constructor or deduction guide for deduction of template arguments of 'multimap'}}
  }
  {
