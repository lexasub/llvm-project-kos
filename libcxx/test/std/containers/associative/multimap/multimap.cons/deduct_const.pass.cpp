...
int main(int, char**) {
  {
    ...
    const PCC expected_m[] = {
        {1, 1L}, {1, 1L}, {2, 2L}, {3, 1L}, {INT_MAX, 1L}};
...

  {
    ...
    ASSERT_SAME_TYPE(decltype(m),
                     std::multimap<int, const long, std::greater<int> >);
    const PCC expected_m[] = {
        {INT_MAX, 1L}, {3, 1L}, {2, 2L}, {1, 1L}, {1, 1L}};
    assert(std::equal(m.begin(), m.end(), std::begin(expected_m),
                      std::end(expected_m)));
  }
  ...
  {
    std::multimap m{PC{1, 1L}, PC{2, 2L}, PC{1, 1L}, PC{INT_MAX, 1L},
                    PC{3, 1L}};
