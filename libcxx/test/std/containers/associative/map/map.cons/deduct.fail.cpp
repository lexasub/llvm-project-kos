...
int main(int, char**) {
  {
    ...
    std::map
        m; // expected-error{{no viable constructor or deduction guide for deduction of template arguments of 'map'}}
  }
  {
  ...
  }
  {
    ...
    NotAnAllocator a;
    std::map m(
        a); // expected-error{{no viable constructor or deduction guide for deduction of template arguments of 'map'}}
  }
  {
