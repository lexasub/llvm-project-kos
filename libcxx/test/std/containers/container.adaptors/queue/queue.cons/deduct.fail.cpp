...
int main(int, char**) {
  //  Test the explicit deduction guides
  {
    ...
    std::queue que(
        std::list<int>{1, 2, 3},
        45); // expected-error {{no viable constructor or deduction guide for deduction of template arguments of 'queue'}}
  }
  ...
  //  Test the implicit deduction guides
  {
    ...
    std::queue que(
        (std::allocator<
            int>())); // expected-error {{no viable constructor or deduction guide for deduction of template arguments of 'queue'}}
