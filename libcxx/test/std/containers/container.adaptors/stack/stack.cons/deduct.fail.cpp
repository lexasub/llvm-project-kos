...
int main(int, char**) {
  //  Test the explicit deduction guides
  {
    ...
    std::stack stk(
        std::list<int>({1, 2, 3}),
        45); // expected-error {{no viable constructor or deduction guide for deduction of template arguments of 'stack'}}
  }
  ...
  //  Test the implicit deduction guides
  {
    ...
    std::stack stk(
        (std::allocator<
            int>())); // expected-error {{no viable constructor or deduction guide for deduction of template arguments of 'stack'}}
