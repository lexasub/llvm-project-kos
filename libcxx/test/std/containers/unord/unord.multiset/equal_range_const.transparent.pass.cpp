...
int main(int, char**) {
...

  {
    ...
    using set_type = const unord_set_type<std::unordered_multiset,
                                          transparent_hash, std::equal_to<> >;
    test_transparent_equal_range<set_type>(key_type{1}, key_type{1},
                                           key_type{2});
  }

  {
    ...
    using set_type =
        const unord_set_type<std::unordered_multiset, transparent_hash_final,
...

  {
    ...
    using set_type =
        const unord_set_type<std::unordered_multiset, non_transparent_hash,
                             std::equal_to<> >;
    test_non_transparent_equal_range<set_type>(key_type{1}, key_type{1},
                                               key_type{2});
  }

  {
    ...
    using set_type =
        const unord_set_type<std::unordered_multiset, transparent_hash,
