...
int main(int, char**) {
  using P = std::pair<const int, int>;
  {
    ...
    std::unordered_multimap
        m; // expected-error{{no viable constructor or deduction guide for deduction of template arguments of 'unordered_multimap'}}
  }
  {
    // cannot deduce Key from just (Size)
    std::unordered_multimap m(
        42); // expected-error{{no viable constructor or deduction guide for deduction of template arguments of 'unordered_multimap'}}
  }
  {
