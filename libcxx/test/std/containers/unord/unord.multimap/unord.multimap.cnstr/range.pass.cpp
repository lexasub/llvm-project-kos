...
int main(int, char**) {
  {
    ...
    C c(input_iterator<P*>(a),
        input_iterator<P*>(a + sizeof(a) / sizeof(a[0])));
...
#if TEST_STD_VER > 11
  {
    ...
    A a(42);
    C c(input_iterator<P*>(arr),
        input_iterator<P*>(arr + sizeof(arr) / sizeof(arr[0])), 14, a);
  ...
  }
  {
    ...
    HF hf(43);
    C c(input_iterator<P*>(arr),
        input_iterator<P*>(arr + sizeof(arr) / sizeof(arr[0])), 12, hf, a);
