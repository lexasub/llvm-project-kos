...
int main(int, char**) {
...

  {
    ...
    using map_type = const unord_map_type<std::unordered_multimap,
...

  {
    ...
    using map_type =
        const unord_map_type<std::unordered_multimap, transparent_hash_final,
...

  {
    ...
    using map_type =
        const unord_map_type<std::unordered_multimap, non_transparent_hash,
                             std::equal_to<> >;
    test_non_transparent_equal_range<map_type>(
...

  {
    ...
    using map_type =
        const unord_map_type<std::unordered_multimap, transparent_hash,
