...
int main(int, char**) {
  {
    ...
    static_assert((std::is_same<C::hasher, std::hash<C::key_type> >::value),
                  "");
    static_assert(
        (std::is_same<C::key_equal, std::equal_to<C::key_type> >::value), "");
    static_assert((std::is_same<C::allocator_type,
                                std::allocator<C::value_type> >::value),
                  "");
    static_assert(
        (std::is_same<C::value_type,
                      std::pair<const C::key_type, C::mapped_type> >::value),
        "");
...
#if TEST_STD_VER >= 11
  {
    typedef std::unordered_multimap<
        char, short, std::hash<char>, std::equal_to<char>,
