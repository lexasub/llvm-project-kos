...
int main(int, char**) {
...

  {
    ...
    using map_type =
        unord_map_type<std::unordered_multimap, transparent_hash_final,
...

  {
    ...
    using map_type = unord_map_type<std::unordered_multimap,
...

  {
    ...
    using map_type =
        unord_map_type<std::unordered_multimap, non_transparent_hash,
                       std::equal_to<key_type> >;
    test_non_transparent_equal_range<map_type>(
        ilist_type{{1, 2}, {1, 3}, {2, 3}});
  }
