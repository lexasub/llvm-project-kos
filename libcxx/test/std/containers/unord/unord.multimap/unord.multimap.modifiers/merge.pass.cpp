...
int main(int, char**) {
  ...
  {
    bool do_throw = false;
    typedef std::unordered_multimap<Counter<int>, int,
                                    throw_hasher<Counter<int> > >
        map_type;
  ...
  {
    typedef std::unordered_multimap<Counter<int>, int, std::hash<Counter<int> >,
...

    {
      ...
      assert(map_equal(
          first,
          {{1, 0}, {2, 0}, {3, 0}, {4, 0}, {2, 0}, {3, 0}, {1, 0}, {3, 0}}));
