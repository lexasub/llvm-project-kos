...
void CheckConsecutiveValues(Iter pos, Iter end, typename Iter::value_type value,
                            size_t count) {
...
template <typename Iter>
void CheckConsecutiveKeys(
    Iter pos, Iter end, typename Iter::value_type::first_type key,
