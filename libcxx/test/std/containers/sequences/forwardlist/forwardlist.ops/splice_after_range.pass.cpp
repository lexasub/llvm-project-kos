...
template <class C>
void testd(const C& c, ptrdiff_t p, ptrdiff_t f, ptrdiff_t l) {
...
template <class C>
void tests(const C& c, ptrdiff_t p, ptrdiff_t f, ptrdiff_t l) {
  typename C::const_iterator i = c.begin();
  ptrdiff_t n = 0;
