...
void test_iterators() {
  ...
  static_assert((std::is_same<typename ItT::iterator_category,
                ...
                "");
  static_assert(
      (std::is_same<typename ItT::value_type, typename C::value_type>::value),
      "");
  static_assert(
      (std::is_same<typename ItT::reference, typename C::reference>::value),
      "");
  static_assert(
      (std::is_same<typename ItT::pointer, typename C::pointer>::value), "");
  ...
  static_assert((std::is_same<typename CItT::iterator_category,
                ...
                "");
  static_assert(
      (std::is_same<typename CItT::value_type, typename C::value_type>::value),
      "");
  static_assert((std::is_same<typename CItT::reference,
                              typename C::const_reference>::value),
                "");
  static_assert(
      (std::is_same<typename CItT::pointer, typename C::const_pointer>::value),
      "");
...
int main(int, char**) {
  {
    ...
    static_assert((std::is_same<C::reverse_iterator,
                  ...
                  "");
    static_assert(
        (std::is_same<C::const_reverse_iterator,
