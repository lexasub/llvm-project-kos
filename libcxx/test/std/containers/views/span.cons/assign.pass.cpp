...
int main(int, char**) {
  ...
  //  constexpr statically sized assignment
  {
    ...
    constexpr spanType spans[] = {
        spanType{carr1, 2}, spanType{carr1 + 1, 2}, spanType{carr1 + 2, 2},
        spanType{carr2, 2}, spanType{carr2 + 1, 2}, spanType{carr3, 2}};
  ...
  //  statically sized assignment
  {
    ...
    spanType spans[] = {spanType{arr, arr + 2}, spanType{arr + 1, arr + 3},
  ...
  //  dynamically sized assignment
  {
    std::span<std::string> spans[] = {
        {strs, strs},         {strs, strs + 1},     {strs, strs + 2},
        {strs, strs + 3},     {strs + 1, strs + 1}, {strs + 1, strs + 2},
        {strs + 1, strs + 3}, {strs + 2, strs + 2}, {strs + 2, strs + 3},
        {strs + 3, strs + 3}};
...

  {
    ...
    spanType spans[] = {spanType{strs, strs + 1}, spanType{strs + 1, strs + 2},
