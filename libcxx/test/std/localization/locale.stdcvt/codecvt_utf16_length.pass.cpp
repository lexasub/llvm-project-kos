...
int main(int, char**) {
  ...
  }
  {
    ...
    C c;
    char n[6] = {char(0xFE), char(0xFF), char(0xD8),
                 char(0xC0), char(0xDC), char(0x03)};
    std::mbstate_t m;
  ...
  {
    typedef std::codecvt_utf16<wchar_t, 0x10ffff,
                               std::codecvt_mode(std::consume_header |
                                                 std::little_endian)>
        C;
    C c;
    char n[6] = {char(0xFF), char(0xFE), char(0xC0),
                 char(0xD8), char(0x03), char(0xDC)};
    std::mbstate_t m;
    int r = c.length(m, n, n + 6, 2);
    assert(r == 6);
  ...
  {
    typedef std::codecvt_utf16<char16_t, 0x10ffff,
                               std::codecvt_mode(std::consume_header |
                                                 std::little_endian)>
        C;
    C c;
