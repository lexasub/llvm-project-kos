...
class p1 : public std::numpunct<char> {
public:
...
class p2 : public std::numpunct<char> {
public:
...
int main(int, char**) {
  ...
  std::ios ios(0);
  {
    ...
    input_iterator<const char*> iter =
        f.get(input_iterator<const char*>(str),
              input_iterator<const char*>(str + sizeof(str)), ios, err, b);
  ...
  ios.imbue(std::locale(ios.getloc(), new p1));
  {
    ...
    input_iterator<const char*> iter =
        f.get(input_iterator<const char*>(str),
              input_iterator<const char*>(str + 1), ios, err, b);
  ...
  }
  {
    ...
    input_iterator<const char*> iter =
        f.get(input_iterator<const char*>(str),
              input_iterator<const char*>(str + 3), ios, err, b);
  ...
  }
  {
    ...
    input_iterator<const char*> iter =
        f.get(input_iterator<const char*>(str),
              input_iterator<const char*>(str + 2), ios, err, b);
    assert(iter.base() == str + 2);
    assert(err == ios.eofbit);
    assert(b == false);
  }
