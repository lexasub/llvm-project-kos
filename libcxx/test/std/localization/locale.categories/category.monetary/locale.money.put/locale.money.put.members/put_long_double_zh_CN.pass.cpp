...
int main(int, char**) {
                        ...
                        new std::moneypunct_byname<wchar_t, true>(loc_name)));
  {
    ...
    { // zero
      ...
      output_iterator<char*> iter =
          f.put(output_iterator<char*>(str), false, ios, '*', v);
    ...
    { // zero
      ...
      char str[100];
      output_iterator<char*> iter =
          f.put(output_iterator<char*>(str), true, ios, '*', v);
      std::string ex(str, iter.base());
      assert(ex == "0.00");
    }
    { // negative one
  ...
  }
  {
    ...
    { // zero
      long double v = 0;
      wchar_t str[100];
      output_iterator<wchar_t*> iter =
          f.put(output_iterator<wchar_t*>(str), false, ios, '*', v);
    ...
    { // zero
      ...
      wchar_t str[100];
      output_iterator<wchar_t*> iter =
          f.put(output_iterator<wchar_t*>(str), true, ios, '*', v);
      std::wstring ex(str, iter.base());
      assert(ex == L"0.00");
    }
    { // negative one
