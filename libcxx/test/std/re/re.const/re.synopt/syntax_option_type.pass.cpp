...
int main(int, char**) {
  ...
  assert((std::regex_constants::nosubs & std::regex_constants::ECMAScript) ==
         0);
  ...
  assert((std::regex_constants::optimize & std::regex_constants::ECMAScript) ==
         0);
  assert((std::regex_constants::optimize & std::regex_constants::basic) == 0);
  assert((std::regex_constants::optimize & std::regex_constants::extended) ==
         0);
  ...
  assert((std::regex_constants::optimize & std::regex_constants::multiline) ==
         0);

  assert((std::regex_constants::collate & std::regex_constants::ECMAScript) ==
         0);
  ...
  assert((std::regex_constants::collate & std::regex_constants::multiline) ==
         0);

  assert((std::regex_constants::ECMAScript & std::regex_constants::basic) == 0);
  assert((std::regex_constants::ECMAScript & std::regex_constants::extended) ==
         0);
  ...
  assert((std::regex_constants::ECMAScript & std::regex_constants::multiline) ==
         0);
  ...
  assert((std::regex_constants::extended & std::regex_constants::multiline) ==
         0);
