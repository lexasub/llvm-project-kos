...
int main(int, char**) {
  ...
  }
  {
    ...
    assert(e.what() ==
           std::string("The expression contained an invalid back reference."));
  }
  {
    std::regex_error e(std::regex_constants::error_brack);
    assert(e.code() == std::regex_constants::error_brack);
    assert(e.what() ==
           std::string("The expression contained mismatched [ and ]."));
  }
  {
  ...
  }
  {
    ...
    assert(e.what() ==
           std::string("The expression contained an invalid character range, "
  ...
  }
  {
    ...
    assert(e.what() ==
           std::string("The complexity of an attempted match against a regular "
