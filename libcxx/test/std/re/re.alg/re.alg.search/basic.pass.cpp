...
int main(int, char**) {
  ...
  }
  {
    ...
    const char s[] = "a";
    assert(
        std::regex_search(s, m, std::regex("a", std::regex_constants::basic)));
    assert(m.size() == 1);
    assert(!m.empty());
  ...
  }
  {
    ...
    const char s[] = "ab";
    assert(
        std::regex_search(s, m, std::regex("ab", std::regex_constants::basic)));
    assert(m.size() == 1);
    assert(!m.prefix().matched);
    assert(m.prefix().first == s);
    assert(m.prefix().second == m[0].first);
  ...
  }
  {
    ...
    assert(!std::regex_search(s, m,
                              std::regex("ba", std::regex_constants::basic)));
    assert(m.size() == 0);
    assert(m.empty());
  }
  {
  ...
  }
  {
    ...
    const char s[] = "abcd";
    assert(
        std::regex_search(s, m, std::regex("bc", std::regex_constants::basic)));
    assert(m.size() == 1);
    assert(m.prefix().matched);
    assert(m.prefix().first == s);
    assert(m.prefix().second == m[0].first);
  ...
  }
  {
    ...
    const char s[] = "abc";
    assert(std::regex_search(s, m,
                             std::regex("a.c", std::regex_constants::basic)));
    assert(m.size() == 1);
    assert(!m.prefix().matched);
    assert(m.prefix().first == s);
    assert(m.prefix().second == m[0].first);
  ...
  }
  {
    ...
    const char s[] = "a";
    assert(std::regex_search(
        s, m, std::regex("^[ab]$", std::regex_constants::basic)));
    assert(m.size() == 1);
    assert(!m.prefix().matched);
    assert(m.prefix().first == s);
    assert(m.prefix().second == m[0].first);
  ...
  }
  {
    ...
    const char s[] = "Iraq";
    assert(!std::regex_search(
        s, m, std::regex("q[^u]", std::regex_constants::basic)));
    assert(m.size() == 0);
  }
  {
    std::cmatch m;
  ...
  }
  {
    ...
    const wchar_t s[] = L"a";
    assert(std::regex_search(s, m,
                             std::wregex(L"a", std::regex_constants::basic)));
    assert(m.size() == 1);
    assert(!m.empty());
    assert(!m.prefix().matched);
    assert(m.prefix().first == s);
