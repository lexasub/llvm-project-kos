...
struct WidgetV1 {
  ...
  WidgetV1(std::allocator_arg_t, EvilAlloc<char> a, int v)
      : value_(v), alloc_(a) {}
...
struct WidgetV3 {
  ...
  WidgetV3(std::allocator_arg_t, EvilAlloc<char> a, int v)
      : value_(v), alloc_(a) {}
...
static_assert(
    std::uses_allocator<WidgetV1, ex::polymorphic_allocator<char> >::value, "");
static_assert(
    std::uses_allocator<WidgetV2, ex::polymorphic_allocator<char> >::value, "");
static_assert(
    std::uses_allocator<WidgetV3, ex::polymorphic_allocator<char> >::value, "");
...
void test_evil() {
  ...
  PMA pma(ex::new_delete_resource());
  {
    ...
    Pair* p = (Pair*)where;
    pma.construct(p, std::piecewise_construct, std::make_tuple(42),
                  std::make_tuple(42));
