...
void test() {
  ...
  do_search(Iter1(ia), Iter1(ia + sa), Iter2(ia + 1), Iter2(ia + 2),
            Iter1(ia + 1));
  do_search(Iter1(ia), Iter1(ia + sa), Iter2(ia + 2), Iter2(ia + 2), Iter1(ia));
  do_search(Iter1(ia), Iter1(ia + sa), Iter2(ia + 2), Iter2(ia + 3),
            Iter1(ia + 2));
  do_search(Iter1(ia), Iter1(ia + sa), Iter2(ia + 2), Iter2(ia + 3),
            Iter1(ia + 2));
  do_search(Iter1(ia), Iter1(ia), Iter2(ia + 2), Iter2(ia + 3), Iter1(ia));
  do_search(Iter1(ia), Iter1(ia + sa), Iter2(ia + sa - 1), Iter2(ia + sa),
            Iter1(ia + sa - 1));
  ...
  do_search(Iter1(ij), Iter1(ij + sj), Iter2(ik), Iter2(ik + sk),
            Iter1(ij + 6));
}
...
int main(int, char**) {
  ...
  test2<random_access_iterator<const char*>,
        random_access_iterator<const char*> >();
