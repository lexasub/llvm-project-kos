...
int main(int, char**) {
  static_assert(static_cast<int>(std::errc::address_family_not_supported) ==
                    EAFNOSUPPORT,
                "");
  static_assert(static_cast<int>(std::errc::address_in_use) == EADDRINUSE, "");
  static_assert(
      static_cast<int>(std::errc::address_not_available) == EADDRNOTAVAIL, "");
  ...
  static_assert(static_cast<int>(std::errc::connection_aborted) == ECONNABORTED,
                "");
  static_assert(static_cast<int>(std::errc::connection_already_in_progress) ==
                    EALREADY,
                "");
  ...
  static_assert(static_cast<int>(std::errc::destination_address_required) ==
                    EDESTADDRREQ,
                "");
  ...
  static_assert(static_cast<int>(std::errc::illegal_byte_sequence) == EILSEQ,
                "");
  static_assert(
      static_cast<int>(std::errc::inappropriate_io_control_operation) == ENOTTY,
      "");
  ...
  static_assert(
      static_cast<int>(std::errc::no_such_file_or_directory) == ENOENT, "");
  ...
  static_assert(static_cast<int>(std::errc::operation_canceled) == ECANCELED,
                "");
  static_assert(
      static_cast<int>(std::errc::operation_in_progress) == EINPROGRESS, "");
  static_assert(static_cast<int>(std::errc::operation_not_permitted) == EPERM,
                "");
  static_assert(
      static_cast<int>(std::errc::operation_not_supported) == EOPNOTSUPP, "");
  static_assert(
      static_cast<int>(std::errc::operation_would_block) == EWOULDBLOCK, "");
  ...
  static_assert(static_cast<int>(std::errc::protocol_not_supported) ==
                    EPROTONOSUPPORT,
                "");
  static_assert(static_cast<int>(std::errc::read_only_file_system) == EROFS,
                "");
  static_assert(static_cast<int>(std::errc::resource_deadlock_would_occur) ==
                    EDEADLK,
                "");
  static_assert(static_cast<int>(std::errc::resource_unavailable_try_again) ==
                    EAGAIN,
                "");
  static_assert(static_cast<int>(std::errc::result_out_of_range) == ERANGE, "");
  static_assert(static_cast<int>(std::errc::state_not_recoverable) ==
                    ENOTRECOVERABLE,
                "");
#if (defined(_XOPEN_STREAMS) && _XOPEN_STREAMS != -1)
  ...
  static_assert(
      static_cast<int>(std::errc::too_many_files_open_in_system) == ENFILE, "");
  ...
  static_assert(
      static_cast<int>(std::errc::too_many_symbolic_link_levels) == ELOOP, "");
