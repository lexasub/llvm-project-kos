...
int main(int, char**) {
  ...
  test2("ABCDEABCDEABCDEABCDEABCDEABCDEABCDEABCDEABCDEABCDEABCDEABCDEABCDEABCDE"
  ...
  test2(L"ABCDEABCDEABCDEABCDEABCDEABCDEABCDEABCDEABCDEABCDEABCDEABCDEABCDEABCD"
        L"EABCDEABCDEABCDEABCDEABCDEABCDEABCDE",
        105);
  test2(L"ABCDE", 5);
  test2(L"a", 1);
  test2(L"", 0);
...
#if defined(__cpp_lib_char8_t) && __cpp_lib_char8_t >= 201811L
  test2(u8 "ABCDEABCDEABCDEABCDEABCDEABCDEABCDEABCDEABCDEABCDEABCDEABCDEABCDEAB"
           "CDEABCDEABCDEABCDEABCDEABCDEABCDEABCDE",
        105);
  test2(u8 "ABCDE", 5);
  test2(u8 "a", 1);
  test2(u8 "", 0);
...
#if TEST_STD_VER >= 11
  test2(u "ABCDEABCDEABCDEABCDEABCDEABCDEABCDEABCDEABCDEABCDEABCDEABCDEABCDEABC"
          "DEABCDEABCDEABCDEABCDEABCDEABCDEABCDE",
        105);
  test2(u "ABCDE", 5);
  test2(u "a", 1);
  test2(u "", 0);
