...
void test() {
  ...
  static_assert((std::is_same<typename S::const_reference,
                ...
                "");
  static_assert(
      (std::is_same<typename S::pointer, typename S::value_type*>::value), "");
  static_assert((std::is_same<typename S::const_pointer,
                              const typename S::value_type*>::value),
                "");
  ...
  static_assert(
      (std::is_same<typename S::iterator, typename S::const_iterator>::value),
      "");
  static_assert((std::is_same<typename S::reverse_iterator,
                              typename S::const_reverse_iterator>::value),
                "");
}
