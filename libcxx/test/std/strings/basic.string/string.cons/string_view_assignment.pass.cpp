...
int main(int, char**) {
  {
    ...
    test(S(), SV("abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvwxyzabcdefghi"
                 "jklmnopqrstuvwxyz"));
    test(S("123456789"), SV("abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvwx"
                            "yzabcdefghijklmnopqrstuvwxyz"));
    test(S("1234567890123456789012345678901234567890123456789012345678901234567"
           "890"),
         SV("abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvwxyzabcdefghijklmn"
            "opqrstuvwxyz"));
    test(S("1234567890123456789012345678901234567890123456789012345678901234567"
           "890"
