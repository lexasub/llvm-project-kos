...
template <class S>
void test(S s1, const typename S::value_type* s2) {
...
int main(int, char**) {
  {
    ...
    test(S(), "abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvwxyzabcdefghijkl"
              "mnopqrstuvwxyz");
    test(S("123456789"), "abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvwxyza"
