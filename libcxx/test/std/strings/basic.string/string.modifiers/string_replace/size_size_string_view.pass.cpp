...
void test(S s, typename S::size_type pos1, typename S::size_type n1, SV sv,
          S expected) {
...
void test0() {
  ...
  test(S("abcde"), 0, 0, SV("12345678901234567890"),
  ...
  test(S("abcde"), 0, 1, SV("12345678901234567890"),
  ...
  test(S("abcde"), 0, 2, SV("12345678901234567890"),
  ...
  test(S("abcde"), 0, 4, SV("12345678901234567890"),
  ...
  test(S("abcde"), 1, 0, SV("12345678901234567890"),
  ...
  test(S("abcde"), 1, 1, SV("12345678901234567890"),
  ...
  test(S("abcde"), 1, 2, SV("12345678901234567890"),
  ...
  test(S("abcde"), 1, 3, SV("12345678901234567890"),
  ...
  test(S("abcde"), 1, 4, SV("12345678901234567890"),
  ...
  test(S("abcde"), 2, 1, SV("12345678901234567890"),
  ...
  test(S("abcde"), 2, 2, SV("12345678901234567890"),
  ...
  test(S("abcde"), 2, 3, SV("12345678901234567890"),
  ...
  test(S("abcde"), 4, 1, SV("12345678901234567890"),
  ...
  test(S("abcde"), 5, 1, SV("12345678901234567890"),
       S("abcde12345678901234567890"));
}
...
void test1() {
  ...
  test(S("abcdefghij"), 0, 0, SV("12345678901234567890"),
  ...
  test(S("abcdefghij"), 0, 1, SV("12345678901234567890"),
  ...
  test(S("abcdefghij"), 0, 5, SV("12345678901234567890"),
  ...
  test(S("abcdefghij"), 0, 9, SV("12345678901234567890"),
  ...
  test(S("abcdefghij"), 1, 0, SV("12345678901234567890"),
  ...
  test(S("abcdefghij"), 1, 1, SV("12345678901234567890"),
  ...
  test(S("abcdefghij"), 1, 4, SV("12345678901234567890"),
  ...
  test(S("abcdefghij"), 1, 8, SV("12345678901234567890"),
  ...
  test(S("abcdefghij"), 5, 0, SV("12345678901234567890"),
  ...
  test(S("abcdefghij"), 5, 1, SV("12345678901234567890"),
  ...
  test(S("abcdefghij"), 5, 2, SV("12345678901234567890"),
  ...
  test(S("abcdefghij"), 5, 4, SV("12345678901234567890"),
  ...
  test(S("abcdefghij"), 5, 5, SV("12345678901234567890"),
       S("abcde12345678901234567890"));
  ...
  test(S("abcdefghij"), 5, 6, SV("12345678901234567890"),
       S("abcde12345678901234567890"));
  ...
  test(S("abcdefghij"), 9, 0, SV("12345678901234567890"),
  ...
  test(S("abcdefghij"), 9, 1, SV("12345678901234567890"),
  ...
  test(S("abcdefghij"), 9, 2, SV("12345678901234567890"),
       S("abcdefghi12345678901234567890"));
  ...
  test(S("abcdefghij"), 10, 0, SV("12345678901234567890"),
  ...
  test(S("abcdefghij"), 10, 1, SV("12345678901234567890"),
       S("abcdefghij12345678901234567890"));
...
void test2() {
  ...
  test(S("abcdefghijklmnopqrst"), 0, 0, SV("12345"),
       S("12345abcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 0, SV("1234567890"),
       S("1234567890abcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 0, SV("12345678901234567890"),
       S("12345678901234567890abcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 1, SV(""), S("bcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 1, SV("12345"),
       S("12345bcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 1, SV("1234567890"),
       S("1234567890bcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 1, SV("12345678901234567890"),
  ...
  test(S("abcdefghijklmnopqrst"), 0, 10, SV("1234567890"),
       S("1234567890klmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 10, SV("12345678901234567890"),
  ...
  test(S("abcdefghijklmnopqrst"), 0, 19, SV("12345678901234567890"),
  ...
  test(S("abcdefghijklmnopqrst"), 0, 20, SV("12345678901234567890"),
       S("12345678901234567890"));
  ...
  test(S("abcdefghijklmnopqrst"), 0, 21, SV("12345678901234567890"),
       S("12345678901234567890"));
  test(S("abcdefghijklmnopqrst"), 1, 0, SV(""), S("abcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 1, 0, SV("12345"),
       S("a12345bcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 1, 0, SV("1234567890"),
       S("a1234567890bcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 1, 0, SV("12345678901234567890"),
       S("a12345678901234567890bcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 1, 1, SV(""), S("acdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 1, 1, SV("12345"),
       S("a12345cdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 1, 1, SV("1234567890"),
       S("a1234567890cdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 1, 1, SV("12345678901234567890"),
  ...
  test(S("abcdefghijklmnopqrst"), 1, 9, SV("1234567890"),
       S("a1234567890klmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 1, 9, SV("12345678901234567890"),
  ...
  test(S("abcdefghijklmnopqrst"), 1, 18, SV("12345678901234567890"),
  ...
  test(S("abcdefghijklmnopqrst"), 1, 19, SV("12345678901234567890"),
       S("a12345678901234567890"));
  ...
  test(S("abcdefghijklmnopqrst"), 1, 20, SV("12345678901234567890"),
       S("a12345678901234567890"));
  test(S("abcdefghijklmnopqrst"), 10, 0, SV(""), S("abcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 0, SV("12345"),
       S("abcdefghij12345klmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 0, SV("1234567890"),
       S("abcdefghij1234567890klmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 0, SV("12345678901234567890"),
       S("abcdefghij12345678901234567890klmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 1, SV(""), S("abcdefghijlmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 1, SV("12345"),
       S("abcdefghij12345lmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 1, SV("1234567890"),
       S("abcdefghij1234567890lmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 1, SV("12345678901234567890"),
       S("abcdefghij12345678901234567890lmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 5, SV(""), S("abcdefghijpqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 5, SV("12345"),
       S("abcdefghij12345pqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 5, SV("1234567890"),
       S("abcdefghij1234567890pqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 5, SV("12345678901234567890"),
  ...
  test(S("abcdefghijklmnopqrst"), 10, 9, SV("1234567890"),
       S("abcdefghij1234567890t"));
  test(S("abcdefghijklmnopqrst"), 10, 9, SV("12345678901234567890"),
  ...
  test(S("abcdefghijklmnopqrst"), 10, 10, SV("1234567890"),
       S("abcdefghij1234567890"));
  test(S("abcdefghijklmnopqrst"), 10, 10, SV("12345678901234567890"),
       S("abcdefghij12345678901234567890"));
  test(S("abcdefghijklmnopqrst"), 10, 11, SV(""), S("abcdefghij"));
  test(S("abcdefghijklmnopqrst"), 10, 11, SV("12345"), S("abcdefghij12345"));
  test(S("abcdefghijklmnopqrst"), 10, 11, SV("1234567890"),
       S("abcdefghij1234567890"));
  test(S("abcdefghijklmnopqrst"), 10, 11, SV("12345678901234567890"),
       S("abcdefghij12345678901234567890"));
  test(S("abcdefghijklmnopqrst"), 19, 0, SV(""), S("abcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 19, 0, SV("12345"),
       S("abcdefghijklmnopqrs12345t"));
  test(S("abcdefghijklmnopqrst"), 19, 0, SV("1234567890"),
       S("abcdefghijklmnopqrs1234567890t"));
  test(S("abcdefghijklmnopqrst"), 19, 0, SV("12345678901234567890"),
       S("abcdefghijklmnopqrs12345678901234567890t"));
  test(S("abcdefghijklmnopqrst"), 19, 1, SV(""), S("abcdefghijklmnopqrs"));
  test(S("abcdefghijklmnopqrst"), 19, 1, SV("12345"),
       S("abcdefghijklmnopqrs12345"));
  test(S("abcdefghijklmnopqrst"), 19, 1, SV("1234567890"),
       S("abcdefghijklmnopqrs1234567890"));
  test(S("abcdefghijklmnopqrst"), 19, 1, SV("12345678901234567890"),
       S("abcdefghijklmnopqrs12345678901234567890"));
  test(S("abcdefghijklmnopqrst"), 19, 2, SV(""), S("abcdefghijklmnopqrs"));
  test(S("abcdefghijklmnopqrst"), 19, 2, SV("12345"),
       S("abcdefghijklmnopqrs12345"));
  test(S("abcdefghijklmnopqrst"), 19, 2, SV("1234567890"),
       S("abcdefghijklmnopqrs1234567890"));
  test(S("abcdefghijklmnopqrst"), 19, 2, SV("12345678901234567890"),
       S("abcdefghijklmnopqrs12345678901234567890"));
  test(S("abcdefghijklmnopqrst"), 20, 0, SV(""), S("abcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 20, 0, SV("12345"),
       S("abcdefghijklmnopqrst12345"));
  test(S("abcdefghijklmnopqrst"), 20, 0, SV("1234567890"),
       S("abcdefghijklmnopqrst1234567890"));
  test(S("abcdefghijklmnopqrst"), 20, 0, SV("12345678901234567890"),
       S("abcdefghijklmnopqrst12345678901234567890"));
  test(S("abcdefghijklmnopqrst"), 20, 1, SV(""), S("abcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 20, 1, SV("12345"),
       S("abcdefghijklmnopqrst12345"));
  test(S("abcdefghijklmnopqrst"), 20, 1, SV("1234567890"),
       S("abcdefghijklmnopqrst1234567890"));
  test(S("abcdefghijklmnopqrst"), 20, 1, SV("12345678901234567890"),
       S("abcdefghijklmnopqrst12345678901234567890"));
  ...
  test(S("abcdefghijklmnopqrst"), 21, 0, SV("12345678901234567890"),
       S("can't happen"));
}
