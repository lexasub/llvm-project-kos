...
void test1() {
  ...
  test(S("abcdefghijklmnopqrst"), 0, 0, 10, '3',
       S("3333333333abcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 0, 20, '3',
       S("33333333333333333333abcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 1, 0, '3', S("bcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 1, 5, '3', S("33333bcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 1, 10, '3',
       S("3333333333bcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 1, 20, '3',
       S("33333333333333333333bcdefghijklmnopqrst"));
  ...
  test(S("abcdefghijklmnopqrst"), 0, 10, 20, '3',
       S("33333333333333333333klmnopqrst"));
  ...
  test(S("abcdefghijklmnopqrst"), 1, 0, 10, '3',
       S("a3333333333bcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 1, 0, 20, '3',
       S("a33333333333333333333bcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 1, 1, 0, '3', S("acdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 1, 1, 5, '3', S("a33333cdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 1, 1, 10, '3',
       S("a3333333333cdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 1, 1, 20, '3',
       S("a33333333333333333333cdefghijklmnopqrst"));
  ...
  test(S("abcdefghijklmnopqrst"), 1, 9, 20, '3',
       S("a33333333333333333333klmnopqrst"));
  ...
  test(S("abcdefghijklmnopqrst"), 10, 0, 5, '3',
       S("abcdefghij33333klmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 0, 10, '3',
       S("abcdefghij3333333333klmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 0, 20, '3',
       S("abcdefghij33333333333333333333klmnopqrst"));
  ...
  test(S("abcdefghijklmnopqrst"), 10, 1, 10, '3',
       S("abcdefghij3333333333lmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 1, 20, '3',
       S("abcdefghij33333333333333333333lmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 5, 0, '3', S("abcdefghijpqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 5, 5, '3', S("abcdefghij33333pqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 5, 10, '3',
       S("abcdefghij3333333333pqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 5, 20, '3',
       S("abcdefghij33333333333333333333pqrst"));
  ...
  test(S("abcdefghijklmnopqrst"), 10, 9, 20, '3',
       S("abcdefghij33333333333333333333t"));
}
...
void test2() {
  ...
  test(S("abcdefghijklmnopqrst"), 10, 10, 20, '3',
       S("abcdefghij33333333333333333333"));
  test(S("abcdefghijklmnopqrst"), 19, 0, 0, '3', S("abcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 19, 0, 5, '3',
       S("abcdefghijklmnopqrs33333t"));
  test(S("abcdefghijklmnopqrst"), 19, 0, 10, '3',
       S("abcdefghijklmnopqrs3333333333t"));
  test(S("abcdefghijklmnopqrst"), 19, 0, 20, '3',
       S("abcdefghijklmnopqrs33333333333333333333t"));
  ...
  test(S("abcdefghijklmnopqrst"), 19, 1, 10, '3',
       S("abcdefghijklmnopqrs3333333333"));
  test(S("abcdefghijklmnopqrst"), 19, 1, 20, '3',
       S("abcdefghijklmnopqrs33333333333333333333"));
  test(S("abcdefghijklmnopqrst"), 20, 0, 0, '3', S("abcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 20, 0, 5, '3',
       S("abcdefghijklmnopqrst33333"));
  test(S("abcdefghijklmnopqrst"), 20, 0, 10, '3',
       S("abcdefghijklmnopqrst3333333333"));
  test(S("abcdefghijklmnopqrst"), 20, 0, 20, '3',
       S("abcdefghijklmnopqrst33333333333333333333"));
}
