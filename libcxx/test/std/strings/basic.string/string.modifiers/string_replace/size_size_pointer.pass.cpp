...
void test0() {
  ...
  test(S("abcde"), 1, 0, "12345678901234567890",
  ...
  test(S("abcde"), 2, 0, "12345678901234567890",
  ...
  test(S("abcde"), 4, 0, "12345678901234567890",
  ...
  test(S("abcde"), 5, 1, "12345678901234567890",
       S("abcde12345678901234567890"));
}
...
void test1() {
  ...
  test(S("abcdefghij"), 0, 0, "12345678901234567890",
  ...
  test(S("abcdefghij"), 0, 1, "12345678901234567890",
  ...
  test(S("abcdefghij"), 0, 5, "12345678901234567890",
  ...
  test(S("abcdefghij"), 0, 9, "12345678901234567890",
  ...
  test(S("abcdefghij"), 1, 0, "12345678901234567890",
  ...
  test(S("abcdefghij"), 1, 1, "12345678901234567890",
  ...
  test(S("abcdefghij"), 1, 4, "12345678901234567890",
  ...
  test(S("abcdefghij"), 1, 8, "12345678901234567890",
  ...
  test(S("abcdefghij"), 1, 10, "12345678901234567890",
       S("a12345678901234567890"));
  ...
  test(S("abcdefghij"), 5, 1, "12345678901234567890",
  ...
  test(S("abcdefghij"), 5, 2, "12345678901234567890",
  ...
  test(S("abcdefghij"), 5, 4, "12345678901234567890",
  ...
  test(S("abcdefghij"), 9, 1, "12345678901234567890",
  ...
  test(S("abcdefghij"), 9, 2, "12345678901234567890",
       S("abcdefghi12345678901234567890"));
  ...
  test(S("abcdefghij"), 10, 0, "12345678901234567890",
  ...
  test(S("abcdefghij"), 10, 1, "12345678901234567890",
       S("abcdefghij12345678901234567890"));
...
void test2() {
  ...
  test(S("abcdefghijklmnopqrst"), 0, 0, "12345",
       S("12345abcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 0, "1234567890",
       S("1234567890abcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 0, "12345678901234567890",
  ...
  test(S("abcdefghijklmnopqrst"), 0, 1, "1234567890",
       S("1234567890bcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 1, "12345678901234567890",
  ...
  test(S("abcdefghijklmnopqrst"), 0, 10, "12345678901234567890",
  ...
  test(S("abcdefghijklmnopqrst"), 0, 19, "12345678901234567890",
  ...
  test(S("abcdefghijklmnopqrst"), 0, 20, "12345678901234567890",
       S("12345678901234567890"));
  ...
  test(S("abcdefghijklmnopqrst"), 0, 21, "12345678901234567890",
       S("12345678901234567890"));
  test(S("abcdefghijklmnopqrst"), 1, 0, "", S("abcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 1, 0, "12345",
       S("a12345bcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 1, 0, "1234567890",
  ...
  test(S("abcdefghijklmnopqrst"), 1, 1, "1234567890",
       S("a1234567890cdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 1, 1, "12345678901234567890",
  ...
  test(S("abcdefghijklmnopqrst"), 1, 9, "1234567890",
       S("a1234567890klmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 1, 9, "12345678901234567890",
  ...
  test(S("abcdefghijklmnopqrst"), 1, 18, "12345678901234567890",
  ...
  test(S("abcdefghijklmnopqrst"), 1, 19, "12345678901234567890",
       S("a12345678901234567890"));
  ...
  test(S("abcdefghijklmnopqrst"), 1, 20, "12345678901234567890",
       S("a12345678901234567890"));
  test(S("abcdefghijklmnopqrst"), 10, 0, "", S("abcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 0, "12345",
       S("abcdefghij12345klmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 0, "1234567890",
  ...
  test(S("abcdefghijklmnopqrst"), 10, 1, "12345",
       S("abcdefghij12345lmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 1, "1234567890",
       S("abcdefghij1234567890lmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 1, "12345678901234567890",
  ...
  test(S("abcdefghijklmnopqrst"), 10, 5, "1234567890",
       S("abcdefghij1234567890pqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 5, "12345678901234567890",
  ...
  test(S("abcdefghijklmnopqrst"), 10, 9, "1234567890",
  ...
  test(S("abcdefghijklmnopqrst"), 10, 10, "1234567890",
       S("abcdefghij1234567890"));
  test(S("abcdefghijklmnopqrst"), 10, 10, "12345678901234567890",
       S("abcdefghij12345678901234567890"));
  test(S("abcdefghijklmnopqrst"), 10, 11, "", S("abcdefghij"));
  test(S("abcdefghijklmnopqrst"), 10, 11, "12345", S("abcdefghij12345"));
  test(S("abcdefghijklmnopqrst"), 10, 11, "1234567890",
       S("abcdefghij1234567890"));
  test(S("abcdefghijklmnopqrst"), 10, 11, "12345678901234567890",
       S("abcdefghij12345678901234567890"));
  test(S("abcdefghijklmnopqrst"), 19, 0, "", S("abcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 19, 0, "12345",
       S("abcdefghijklmnopqrs12345t"));
  test(S("abcdefghijklmnopqrst"), 19, 0, "1234567890",
  ...
  test(S("abcdefghijklmnopqrst"), 19, 1, "12345",
       S("abcdefghijklmnopqrs12345"));
  test(S("abcdefghijklmnopqrst"), 19, 1, "1234567890",
       S("abcdefghijklmnopqrs1234567890"));
  test(S("abcdefghijklmnopqrst"), 19, 1, "12345678901234567890",
       S("abcdefghijklmnopqrs12345678901234567890"));
  test(S("abcdefghijklmnopqrst"), 19, 2, "", S("abcdefghijklmnopqrs"));
  test(S("abcdefghijklmnopqrst"), 19, 2, "12345",
       S("abcdefghijklmnopqrs12345"));
  test(S("abcdefghijklmnopqrst"), 19, 2, "1234567890",
       S("abcdefghijklmnopqrs1234567890"));
  test(S("abcdefghijklmnopqrst"), 19, 2, "12345678901234567890",
       S("abcdefghijklmnopqrs12345678901234567890"));
  test(S("abcdefghijklmnopqrst"), 20, 0, "", S("abcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 20, 0, "12345",
       S("abcdefghijklmnopqrst12345"));
  test(S("abcdefghijklmnopqrst"), 20, 0, "1234567890",
       S("abcdefghijklmnopqrst1234567890"));
  test(S("abcdefghijklmnopqrst"), 20, 0, "12345678901234567890",
       S("abcdefghijklmnopqrst12345678901234567890"));
  test(S("abcdefghijklmnopqrst"), 20, 1, "", S("abcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 20, 1, "12345",
       S("abcdefghijklmnopqrst12345"));
  test(S("abcdefghijklmnopqrst"), 20, 1, "1234567890",
       S("abcdefghijklmnopqrst1234567890"));
  test(S("abcdefghijklmnopqrst"), 20, 1, "12345678901234567890",
       S("abcdefghijklmnopqrst12345678901234567890"));
  ...
  test(S("abcdefghijklmnopqrst"), 21, 0, "12345678901234567890",
       S("can't happen"));
}
