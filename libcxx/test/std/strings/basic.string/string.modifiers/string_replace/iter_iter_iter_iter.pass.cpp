...
void test(S s, typename S::size_type pos1, typename S::size_type n1, It f, It l,
          S expected) {
...
template <class S, class It>
void test_exceptions(S s, typename S::size_type pos1, typename S::size_type n1,
                     It f, It l) {
  typename S::const_iterator first = s.begin() + pos1;
  typename S::const_iterator last = s.begin() + pos1 + n1;
  S aCopy = s;
...
void test3() {
  test(S("abcdefghij"), 0, 0, str, str + 1, S("1abcdefghij"));
  test(S("abcdefghij"), 0, 0, str, str + 10, S("1234567890abcdefghij"));
  test(S("abcdefghij"), 0, 0, str, str + 19,
       S("1234567890123456789abcdefghij"));
  test(S("abcdefghij"), 0, 0, str, str + 20,
  ...
  test(S("abcdefghij"), 0, 1, str, str + 20,
  ...
  test(S("abcdefghij"), 1, 0, str, str + 1, S("a1bcdefghij"));
  test(S("abcdefghij"), 1, 0, str, str + 10, S("a1234567890bcdefghij"));
  test(S("abcdefghij"), 1, 0, str, str + 19,
       S("a1234567890123456789bcdefghij"));
  test(S("abcdefghij"), 1, 0, str, str + 20,
  ...
  test(S("abcdefghij"), 1, 1, str, str + 20,
...
void test4() {
  ...
  test(S("abcdefghij"), 5, 0, str, str + 1, S("abcde1fghij"));
  test(S("abcdefghij"), 5, 0, str, str + 10, S("abcde1234567890fghij"));
  test(S("abcdefghij"), 5, 0, str, str + 19,
       S("abcde1234567890123456789fghij"));
  test(S("abcdefghij"), 5, 0, str, str + 20,
  ...
  test(S("abcdefghij"), 5, 1, str, str + 20,
...
void test5() {
  ...
  test(S("abcdefghij"), 9, 0, str, str + 1, S("abcdefghi1j"));
  test(S("abcdefghij"), 9, 0, str, str + 10, S("abcdefghi1234567890j"));
  test(S("abcdefghij"), 9, 0, str, str + 19,
       S("abcdefghi1234567890123456789j"));
  test(S("abcdefghij"), 9, 0, str, str + 20,
  ...
  test(S("abcdefghij"), 9, 1, str, str + 20,
  ...
  test(S("abcdefghij"), 10, 0, str, str + 1, S("abcdefghij1"));
  test(S("abcdefghij"), 10, 0, str, str + 10, S("abcdefghij1234567890"));
  test(S("abcdefghij"), 10, 0, str, str + 19,
       S("abcdefghij1234567890123456789"));
  test(S("abcdefghij"), 10, 0, str, str + 20,
       S("abcdefghij12345678901234567890"));
  test(S("abcdefghijklmnopqrst"), 0, 0, str, str + 0,
       S("abcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 0, str, str + 0,
       S("abcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 0, str, str + 1,
       S("1abcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 0, str, str + 2,
       S("12abcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 0, str, str + 4,
       S("1234abcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 0, str, str + 5,
  ...
  test(S("abcdefghijklmnopqrst"), 0, 0, str, str + 5,
       S("12345abcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 0, str, str + 9,
       S("123456789abcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 0, str, str + 10,
  ...
  test(S("abcdefghijklmnopqrst"), 0, 0, str, str + 10,
       S("1234567890abcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 0, str, str + 19,
       S("1234567890123456789abcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 0, str, str + 20,
       S("12345678901234567890abcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 1, str, str + 0, S("bcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 1, str, str + 0, S("bcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 1, str, str + 1,
       S("1bcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 1, str, str + 2,
       S("12bcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 1, str, str + 4,
       S("1234bcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 1, str, str + 5,
...
void test6() {
  test(S("abcdefghijklmnopqrst"), 0, 1, str, str + 5,
       S("12345bcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 1, str, str + 9,
       S("123456789bcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 1, str, str + 10,
  ...
  test(S("abcdefghijklmnopqrst"), 0, 1, str, str + 10,
       S("1234567890bcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 1, str, str + 19,
       S("1234567890123456789bcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 1, str, str + 20,
  ...
  test(S("abcdefghijklmnopqrst"), 0, 10, str, str + 1, S("1klmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 10, str, str + 5, S("12345klmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 10, str, str + 9,
       S("123456789klmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 10, str, str + 10,
       S("1234567890klmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 10, str, str + 0, S("klmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 10, str, str + 1, S("1klmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 10, str, str + 10,
       S("1234567890klmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 10, str, str + 19,
       S("1234567890123456789klmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 10, str, str + 20,
  ...
  test(S("abcdefghijklmnopqrst"), 0, 19, str, str + 1, S("1t"));
  test(S("abcdefghijklmnopqrst"), 0, 19, str, str + 10, S("1234567890t"));
  test(S("abcdefghijklmnopqrst"), 0, 19, str, str + 19,
       S("1234567890123456789t"));
  test(S("abcdefghijklmnopqrst"), 0, 19, str, str + 20,
  ...
  test(S("abcdefghijklmnopqrst"), 0, 20, str, str + 1, S("1"));
  test(S("abcdefghijklmnopqrst"), 0, 20, str, str + 10, S("1234567890"));
  test(S("abcdefghijklmnopqrst"), 0, 20, str, str + 19,
       S("1234567890123456789"));
  test(S("abcdefghijklmnopqrst"), 0, 20, str, str + 20,
       S("12345678901234567890"));
  test(S("abcdefghijklmnopqrst"), 1, 0, str, str + 0,
       S("abcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 1, 0, str, str + 0,
       S("abcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 1, 0, str, str + 1,
       S("a1bcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 1, 0, str, str + 2,
       S("a12bcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 1, 0, str, str + 4,
       S("a1234bcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 1, 0, str, str + 5,
  ...
  test(S("abcdefghijklmnopqrst"), 1, 0, str, str + 5,
       S("a12345bcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 1, 0, str, str + 9,
       S("a123456789bcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 1, 0, str, str + 10,
  ...
  test(S("abcdefghijklmnopqrst"), 1, 0, str, str + 10,
       S("a1234567890bcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 1, 0, str, str + 19,
       S("a1234567890123456789bcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 1, 0, str, str + 20,
       S("a12345678901234567890bcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 1, 1, str, str + 0, S("acdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 1, 1, str, str + 0, S("acdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 1, 1, str, str + 1,
       S("a1cdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 1, 1, str, str + 2,
       S("a12cdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 1, 1, str, str + 4,
       S("a1234cdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 1, 1, str, str + 5,
  ...
  test(S("abcdefghijklmnopqrst"), 1, 1, str, str + 5,
       S("a12345cdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 1, 1, str, str + 9,
       S("a123456789cdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 1, 1, str, str + 10,
  ...
  test(S("abcdefghijklmnopqrst"), 1, 1, str, str + 10,
       S("a1234567890cdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 1, 1, str, str + 19,
       S("a1234567890123456789cdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 1, 1, str, str + 20,
  ...
  test(S("abcdefghijklmnopqrst"), 1, 9, str, str + 1, S("a1klmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 1, 9, str, str + 5, S("a12345klmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 1, 9, str, str + 9,
       S("a123456789klmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 1, 9, str, str + 10,
...
void test7() {
  ...
  test(S("abcdefghijklmnopqrst"), 1, 9, str, str + 10,
       S("a1234567890klmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 1, 9, str, str + 19,
       S("a1234567890123456789klmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 1, 9, str, str + 20,
  ...
  test(S("abcdefghijklmnopqrst"), 1, 18, str, str + 1, S("a1t"));
  test(S("abcdefghijklmnopqrst"), 1, 18, str, str + 10, S("a1234567890t"));
  test(S("abcdefghijklmnopqrst"), 1, 18, str, str + 19,
       S("a1234567890123456789t"));
  test(S("abcdefghijklmnopqrst"), 1, 18, str, str + 20,
  ...
  test(S("abcdefghijklmnopqrst"), 1, 19, str, str + 1, S("a1"));
  test(S("abcdefghijklmnopqrst"), 1, 19, str, str + 10, S("a1234567890"));
  test(S("abcdefghijklmnopqrst"), 1, 19, str, str + 19,
       S("a1234567890123456789"));
  test(S("abcdefghijklmnopqrst"), 1, 19, str, str + 20,
       S("a12345678901234567890"));
  test(S("abcdefghijklmnopqrst"), 10, 0, str, str + 0,
       S("abcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 0, str, str + 0,
       S("abcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 0, str, str + 1,
       S("abcdefghij1klmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 0, str, str + 2,
       S("abcdefghij12klmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 0, str, str + 4,
       S("abcdefghij1234klmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 0, str, str + 5,
  ...
  test(S("abcdefghijklmnopqrst"), 10, 0, str, str + 5,
       S("abcdefghij12345klmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 0, str, str + 9,
       S("abcdefghij123456789klmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 0, str, str + 10,
  ...
  test(S("abcdefghijklmnopqrst"), 10, 0, str, str + 10,
       S("abcdefghij1234567890klmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 0, str, str + 19,
       S("abcdefghij1234567890123456789klmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 0, str, str + 20,
       S("abcdefghij12345678901234567890klmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 1, str, str + 0,
       S("abcdefghijlmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 1, str, str + 0,
       S("abcdefghijlmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 1, str, str + 1,
       S("abcdefghij1lmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 1, str, str + 2,
       S("abcdefghij12lmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 1, str, str + 4,
       S("abcdefghij1234lmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 1, str, str + 5,
  ...
  test(S("abcdefghijklmnopqrst"), 10, 1, str, str + 5,
       S("abcdefghij12345lmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 1, str, str + 9,
       S("abcdefghij123456789lmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 1, str, str + 10,
  ...
  test(S("abcdefghijklmnopqrst"), 10, 1, str, str + 10,
       S("abcdefghij1234567890lmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 1, str, str + 19,
       S("abcdefghij1234567890123456789lmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 1, str, str + 20,
  ...
  test(S("abcdefghijklmnopqrst"), 10, 5, str, str + 4,
       S("abcdefghij1234pqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 5, str, str + 5,
       S("abcdefghij12345pqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 5, str, str + 0, S("abcdefghijpqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 5, str, str + 1, S("abcdefghij1pqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 5, str, str + 5,
       S("abcdefghij12345pqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 5, str, str + 9,
       S("abcdefghij123456789pqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 5, str, str + 10,
       S("abcdefghij1234567890pqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 5, str, str + 0, S("abcdefghijpqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 5, str, str + 1, S("abcdefghij1pqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 5, str, str + 10,
       S("abcdefghij1234567890pqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 5, str, str + 19,
       S("abcdefghij1234567890123456789pqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 5, str, str + 20,
  ...
  test(S("abcdefghijklmnopqrst"), 10, 9, str, str + 1, S("abcdefghij1t"));
  test(S("abcdefghijklmnopqrst"), 10, 9, str, str + 5, S("abcdefghij12345t"));
  test(S("abcdefghijklmnopqrst"), 10, 9, str, str + 9,
       S("abcdefghij123456789t"));
  test(S("abcdefghijklmnopqrst"), 10, 9, str, str + 10,
       S("abcdefghij1234567890t"));
  test(S("abcdefghijklmnopqrst"), 10, 9, str, str + 0, S("abcdefghijt"));
  test(S("abcdefghijklmnopqrst"), 10, 9, str, str + 1, S("abcdefghij1t"));
  test(S("abcdefghijklmnopqrst"), 10, 9, str, str + 10,
       S("abcdefghij1234567890t"));
  test(S("abcdefghijklmnopqrst"), 10, 9, str, str + 19,
       S("abcdefghij1234567890123456789t"));
  test(S("abcdefghijklmnopqrst"), 10, 9, str, str + 20,
...
void test8() {
  ...
  test(S("abcdefghijklmnopqrst"), 10, 10, str, str + 1, S("abcdefghij1"));
  test(S("abcdefghijklmnopqrst"), 10, 10, str, str + 5, S("abcdefghij12345"));
  test(S("abcdefghijklmnopqrst"), 10, 10, str, str + 9,
       S("abcdefghij123456789"));
  test(S("abcdefghijklmnopqrst"), 10, 10, str, str + 10,
       S("abcdefghij1234567890"));
  test(S("abcdefghijklmnopqrst"), 10, 10, str, str + 0, S("abcdefghij"));
  test(S("abcdefghijklmnopqrst"), 10, 10, str, str + 1, S("abcdefghij1"));
  test(S("abcdefghijklmnopqrst"), 10, 10, str, str + 10,
       S("abcdefghij1234567890"));
  test(S("abcdefghijklmnopqrst"), 10, 10, str, str + 19,
       S("abcdefghij1234567890123456789"));
  test(S("abcdefghijklmnopqrst"), 10, 10, str, str + 20,
       S("abcdefghij12345678901234567890"));
  test(S("abcdefghijklmnopqrst"), 19, 0, str, str + 0,
       S("abcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 19, 0, str, str + 0,
       S("abcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 19, 0, str, str + 1,
       S("abcdefghijklmnopqrs1t"));
  test(S("abcdefghijklmnopqrst"), 19, 0, str, str + 2,
       S("abcdefghijklmnopqrs12t"));
  test(S("abcdefghijklmnopqrst"), 19, 0, str, str + 4,
       S("abcdefghijklmnopqrs1234t"));
  test(S("abcdefghijklmnopqrst"), 19, 0, str, str + 5,
  ...
  test(S("abcdefghijklmnopqrst"), 19, 0, str, str + 5,
       S("abcdefghijklmnopqrs12345t"));
  test(S("abcdefghijklmnopqrst"), 19, 0, str, str + 9,
       S("abcdefghijklmnopqrs123456789t"));
  test(S("abcdefghijklmnopqrst"), 19, 0, str, str + 10,
  ...
  test(S("abcdefghijklmnopqrst"), 19, 0, str, str + 10,
       S("abcdefghijklmnopqrs1234567890t"));
  test(S("abcdefghijklmnopqrst"), 19, 0, str, str + 19,
       S("abcdefghijklmnopqrs1234567890123456789t"));
  test(S("abcdefghijklmnopqrst"), 19, 0, str, str + 20,
       S("abcdefghijklmnopqrs12345678901234567890t"));
  test(S("abcdefghijklmnopqrst"), 19, 1, str, str + 0,
       S("abcdefghijklmnopqrs"));
  test(S("abcdefghijklmnopqrst"), 19, 1, str, str + 0,
       S("abcdefghijklmnopqrs"));
  test(S("abcdefghijklmnopqrst"), 19, 1, str, str + 1,
       S("abcdefghijklmnopqrs1"));
  test(S("abcdefghijklmnopqrst"), 19, 1, str, str + 2,
       S("abcdefghijklmnopqrs12"));
  test(S("abcdefghijklmnopqrst"), 19, 1, str, str + 4,
       S("abcdefghijklmnopqrs1234"));
  test(S("abcdefghijklmnopqrst"), 19, 1, str, str + 5,
  ...
  test(S("abcdefghijklmnopqrst"), 19, 1, str, str + 5,
       S("abcdefghijklmnopqrs12345"));
  test(S("abcdefghijklmnopqrst"), 19, 1, str, str + 9,
       S("abcdefghijklmnopqrs123456789"));
  test(S("abcdefghijklmnopqrst"), 19, 1, str, str + 10,
  ...
  test(S("abcdefghijklmnopqrst"), 19, 1, str, str + 10,
       S("abcdefghijklmnopqrs1234567890"));
  test(S("abcdefghijklmnopqrst"), 19, 1, str, str + 19,
       S("abcdefghijklmnopqrs1234567890123456789"));
  test(S("abcdefghijklmnopqrst"), 19, 1, str, str + 20,
       S("abcdefghijklmnopqrs12345678901234567890"));
  test(S("abcdefghijklmnopqrst"), 20, 0, str, str + 0,
       S("abcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 20, 0, str, str + 0,
       S("abcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 20, 0, str, str + 1,
       S("abcdefghijklmnopqrst1"));
  test(S("abcdefghijklmnopqrst"), 20, 0, str, str + 2,
       S("abcdefghijklmnopqrst12"));
  test(S("abcdefghijklmnopqrst"), 20, 0, str, str + 4,
       S("abcdefghijklmnopqrst1234"));
  test(S("abcdefghijklmnopqrst"), 20, 0, str, str + 5,
  ...
  test(S("abcdefghijklmnopqrst"), 20, 0, str, str + 5,
       S("abcdefghijklmnopqrst12345"));
  test(S("abcdefghijklmnopqrst"), 20, 0, str, str + 9,
       S("abcdefghijklmnopqrst123456789"));
  test(S("abcdefghijklmnopqrst"), 20, 0, str, str + 10,
  ...
  test(S("abcdefghijklmnopqrst"), 20, 0, str, str + 10,
       S("abcdefghijklmnopqrst1234567890"));
  test(S("abcdefghijklmnopqrst"), 20, 0, str, str + 19,
       S("abcdefghijklmnopqrst1234567890123456789"));
  test(S("abcdefghijklmnopqrst"), 20, 0, str, str + 20,
...
int main(int, char**) {
  ...
  { // test iterator operations that throw
    ...
    test_exceptions(S("abcdefghijklmnopqrst"), 10, 5,
                    IIter(TIter(s, s + 10, 4, TIter::TAIncrement)), IIter());
    test_exceptions(S("abcdefghijklmnopqrst"), 10, 5,
                    IIter(TIter(s, s + 10, 5, TIter::TADereference)), IIter());
    test_exceptions(S("abcdefghijklmnopqrst"), 10, 5,
                    IIter(TIter(s, s + 10, 6, TIter::TAComparison)), IIter());

    test_exceptions(S("abcdefghijklmnopqrst"), 10, 5,
                    TIter(s, s + 10, 4, TIter::TAIncrement), TIter());
    test_exceptions(S("abcdefghijklmnopqrst"), 10, 5,
                    TIter(s, s + 10, 5, TIter::TADereference), TIter());
    test_exceptions(S("abcdefghijklmnopqrst"), 10, 5,
                    TIter(s, s + 10, 6, TIter::TAComparison), TIter());
  }
#endif
  ...
  { // test replacing into self
    ...
    s_short.replace(s_short.begin(), s_short.begin(), s_short.begin(),
                    s_short.end());
