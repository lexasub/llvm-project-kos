...
template <class S>
void test(S s, typename S::size_type pos1, typename S::size_type n1, S str,
          S expected) {
...
void test1() {
  ...
  test(S("abcdefghij"), 1, 9, S("12345678901234567890"),
  ...
  test(S("abcdefghij"), 1, 10, S("12345678901234567890"),
       S("a12345678901234567890"));
  ...
  test(S("abcdefghij"), 10, 1, S("12345678901234567890"),
       S("abcdefghij12345678901234567890"));
...
void test2() {
  ...
  test(S("abcdefghijklmnopqrst"), 0, 0, S("12345"),
       S("12345abcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 0, S("1234567890"),
  ...
  test(S("abcdefghijklmnopqrst"), 0, 1, S("12345"),
       S("12345bcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 1, S("1234567890"),
  ...
  test(S("abcdefghijklmnopqrst"), 0, 10, S("1234567890"),
       S("1234567890klmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 0, 10, S("12345678901234567890"),
  ...
  test(S("abcdefghijklmnopqrst"), 0, 19, S("12345678901234567890"),
  ...
  test(S("abcdefghijklmnopqrst"), 1, 0, S("12345"),
       S("a12345bcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 1, 0, S("1234567890"),
  ...
  test(S("abcdefghijklmnopqrst"), 1, 1, S("12345"),
       S("a12345cdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 1, 1, S("1234567890"),
  ...
  test(S("abcdefghijklmnopqrst"), 1, 9, S("1234567890"),
  ...
  test(S("abcdefghijklmnopqrst"), 10, 0, S("12345"),
       S("abcdefghij12345klmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 0, S("1234567890"),
  ...
  test(S("abcdefghijklmnopqrst"), 10, 1, S("12345"),
       S("abcdefghij12345lmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 10, 1, S("1234567890"),
  ...
  test(S("abcdefghijklmnopqrst"), 10, 5, S("1234567890"),
  ...
  test(S("abcdefghijklmnopqrst"), 10, 9, S("1234567890"),
  ...
  test(S("abcdefghijklmnopqrst"), 10, 10, S("1234567890"),
  ...
  test(S("abcdefghijklmnopqrst"), 10, 11, S("1234567890"),
       S("abcdefghij1234567890"));
  test(S("abcdefghijklmnopqrst"), 10, 11, S("12345678901234567890"),
       S("abcdefghij12345678901234567890"));
  test(S("abcdefghijklmnopqrst"), 19, 0, S(""), S("abcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 19, 0, S("12345"),
       S("abcdefghijklmnopqrs12345t"));
  test(S("abcdefghijklmnopqrst"), 19, 0, S("1234567890"),
  ...
  test(S("abcdefghijklmnopqrst"), 19, 1, S("12345"),
       S("abcdefghijklmnopqrs12345"));
  test(S("abcdefghijklmnopqrst"), 19, 1, S("1234567890"),
  ...
  test(S("abcdefghijklmnopqrst"), 19, 2, S("12345"),
       S("abcdefghijklmnopqrs12345"));
  test(S("abcdefghijklmnopqrst"), 19, 2, S("1234567890"),
       S("abcdefghijklmnopqrs1234567890"));
  test(S("abcdefghijklmnopqrst"), 19, 2, S("12345678901234567890"),
       S("abcdefghijklmnopqrs12345678901234567890"));
  test(S("abcdefghijklmnopqrst"), 20, 0, S(""), S("abcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 20, 0, S("12345"),
       S("abcdefghijklmnopqrst12345"));
  test(S("abcdefghijklmnopqrst"), 20, 0, S("1234567890"),
       S("abcdefghijklmnopqrst1234567890"));
  test(S("abcdefghijklmnopqrst"), 20, 0, S("12345678901234567890"),
       S("abcdefghijklmnopqrst12345678901234567890"));
  test(S("abcdefghijklmnopqrst"), 20, 1, S(""), S("abcdefghijklmnopqrst"));
  test(S("abcdefghijklmnopqrst"), 20, 1, S("12345"),
       S("abcdefghijklmnopqrst12345"));
  test(S("abcdefghijklmnopqrst"), 20, 1, S("1234567890"),
       S("abcdefghijklmnopqrst1234567890"));
