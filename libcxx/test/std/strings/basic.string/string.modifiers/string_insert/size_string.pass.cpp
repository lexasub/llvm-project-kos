...
template <class S>
void test(S s, typename S::size_type pos, S str, S expected) {
...
int main(int, char**) {
  {
    ...
    test(S("abcdefghijklmnopqrst"), 0, S("12345"),
         S("12345abcdefghijklmnopqrst"));
    test(S("abcdefghijklmnopqrst"), 0, S("1234567890"),
    ...
    test(S("abcdefghijklmnopqrst"), 1, S("12345"),
         S("a12345bcdefghijklmnopqrst"));
    test(S("abcdefghijklmnopqrst"), 1, S("1234567890"),
    ...
    test(S("abcdefghijklmnopqrst"), 10, S("12345"),
         S("abcdefghij12345klmnopqrst"));
    test(S("abcdefghijklmnopqrst"), 10, S("1234567890"),
    ...
    test(S("abcdefghijklmnopqrst"), 19, S("12345"),
         S("abcdefghijklmnopqrs12345t"));
    test(S("abcdefghijklmnopqrst"), 19, S("1234567890"),
    ...
    test(S("abcdefghijklmnopqrst"), 20, S("12345"),
         S("abcdefghijklmnopqrst12345"));
    test(S("abcdefghijklmnopqrst"), 20, S("1234567890"),
