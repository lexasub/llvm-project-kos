...
void test(S s, typename S::size_type pos, SV sv, S expected) {
...
int main(int, char**) {
  {
    ...
    test(S("abcdefghij"), 5, SV("12345678901234567890"),
    ...
    test(S("abcdefghij"), 9, SV("12345678901234567890"),
    ...
    test(S("abcdefghij"), 10, SV("12345678901234567890"),
    ...
    test(S("abcdefghijklmnopqrst"), 21, SV("12345678901234567890"),
         S("can't happen"));
  }
#if TEST_STD_VER >= 11
  {
