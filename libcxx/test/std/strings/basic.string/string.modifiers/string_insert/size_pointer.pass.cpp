...
int main(int, char**) {
  {
    ...
    test(S("abcdefghij"), 1, "12345678901234567890",
    ...
    test(S("abcdefghij"), 5, "12345678901234567890",
    ...
    test(S("abcdefghij"), 10, "12345678901234567890",
    ...
    test(S("abcdefghijklmnopqrst"), 0, "1234567890",
    ...
    test(S("abcdefghijklmnopqrst"), 21, "12345678901234567890",
         S("can't happen"));
  }
#if TEST_STD_VER >= 11
  {
