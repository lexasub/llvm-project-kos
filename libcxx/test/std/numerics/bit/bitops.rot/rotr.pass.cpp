...
constexpr bool constexpr_test() {
  ...
  return std::rotr(T(128), 0) == T(128) && std::rotr(T(128), 1) == T(64) &&
         std::rotr(T(128), 2) == T(32) && std::rotr(T(128), 3) == T(16) &&
         std::rotr(T(128), 4) == T(8) && std::rotr(T(128), 5) == T(4) &&
         std::rotr(T(128), 6) == T(2) && std::rotr(T(128), 7) == T(1) &&
         std::rotr(max, 0) == max && std::rotr(max, 1) == max &&
         std::rotr(max, 2) == max && std::rotr(max, 3) == max &&
         std::rotr(max, 4) == max && std::rotr(max, 5) == max &&
         std::rotr(max, 6) == max && std::rotr(max, 7) == max;
}
