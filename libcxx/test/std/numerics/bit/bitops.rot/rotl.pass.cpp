...
constexpr bool constexpr_test() {
  ...
  return std::rotl(T(1), 0) == T(1) && std::rotl(T(1), 1) == T(2) &&
         std::rotl(T(1), 2) == T(4) && std::rotl(T(1), 3) == T(8) &&
         std::rotl(T(1), 4) == T(16) && std::rotl(T(1), 5) == T(32) &&
         std::rotl(T(1), 6) == T(64) && std::rotl(T(1), 7) == T(128) &&
         std::rotl(max, 0) == max && std::rotl(max, 1) == max &&
         std::rotl(max, 2) == max && std::rotl(max, 3) == max &&
         std::rotl(max, 4) == max && std::rotl(max, 5) == max &&
         std::rotl(max, 6) == max && std::rotl(max, 7) == max;
}
