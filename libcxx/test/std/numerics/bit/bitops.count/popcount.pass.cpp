...
constexpr bool constexpr_test() {
  return std::popcount(T(0)) == 0 && std::popcount(T(1)) == 1 &&
         std::popcount(T(2)) == 1 && std::popcount(T(3)) == 2 &&
         std::popcount(T(4)) == 1 && std::popcount(T(5)) == 2 &&
         std::popcount(T(6)) == 2 && std::popcount(T(7)) == 3 &&
         std::popcount(T(8)) == 1 && std::popcount(T(9)) == 2 &&
         std::popcount(std::numeric_limits<T>::max()) ==
