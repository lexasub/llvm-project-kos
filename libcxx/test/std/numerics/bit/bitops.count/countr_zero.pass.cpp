...
constexpr bool constexpr_test() {
  ...
  return std::countr_zero(T(0)) == dig && std::countr_zero(T(1)) == 0 &&
         std::countr_zero(T(2)) == 1 && std::countr_zero(T(3)) == 0 &&
         std::countr_zero(T(4)) == 2 && std::countr_zero(T(5)) == 0 &&
         std::countr_zero(T(6)) == 1 && std::countr_zero(T(7)) == 0 &&
         std::countr_zero(T(8)) == 3 && std::countr_zero(T(9)) == 0 &&
