...
constexpr bool constexpr_test() {
  ...
  return std::countr_one(T(0)) == 0 && std::countr_one(T(1)) == 1 &&
         std::countr_one(T(2)) == 0 && std::countr_one(T(3)) == 2 &&
         std::countr_one(T(4)) == 0 && std::countr_one(T(5)) == 1 &&
         std::countr_one(T(6)) == 0 && std::countr_one(T(7)) == 3 &&
         std::countr_one(T(8)) == 0 && std::countr_one(T(9)) == 1 &&
