...
constexpr bool constexpr_test() {
  return std::bit_width(T(0)) == T(0) && std::bit_width(T(1)) == T(1) &&
         std::bit_width(T(2)) == T(2) && std::bit_width(T(3)) == T(2) &&
         std::bit_width(T(4)) == T(3) && std::bit_width(T(5)) == T(3) &&
         std::bit_width(T(6)) == T(3) && std::bit_width(T(7)) == T(3) &&
         std::bit_width(T(8)) == T(4) && std::bit_width(T(9)) == T(4);
}
