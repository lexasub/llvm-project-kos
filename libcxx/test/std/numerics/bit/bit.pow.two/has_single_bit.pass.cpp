...
constexpr bool constexpr_test() {
  return std::has_single_bit(T(1)) && std::has_single_bit(T(2)) &&
         !std::has_single_bit(T(3)) && std::has_single_bit(T(4)) &&
         !std::has_single_bit(T(5)) && !std::has_single_bit(T(6)) &&
         !std::has_single_bit(T(7)) && std::has_single_bit(T(8)) &&
