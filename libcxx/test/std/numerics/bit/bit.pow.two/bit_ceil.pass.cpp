...
constexpr bool constexpr_test() {
  return std::bit_ceil(T(0)) == T(1) && std::bit_ceil(T(1)) == T(1) &&
         std::bit_ceil(T(2)) == T(2) && std::bit_ceil(T(3)) == T(4) &&
         std::bit_ceil(T(4)) == T(4) && std::bit_ceil(T(5)) == T(8) &&
         std::bit_ceil(T(6)) == T(8) && std::bit_ceil(T(7)) == T(8) &&
         std::bit_ceil(T(8)) == T(8) && std::bit_ceil(T(9)) == T(16);
}
