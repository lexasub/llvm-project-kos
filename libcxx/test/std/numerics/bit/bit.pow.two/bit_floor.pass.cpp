...
constexpr bool constexpr_test() {
  return std::bit_floor(T(0)) == T(0) && std::bit_floor(T(1)) == T(1) &&
         std::bit_floor(T(2)) == T(2) && std::bit_floor(T(3)) == T(2) &&
         std::bit_floor(T(4)) == T(4) && std::bit_floor(T(5)) == T(4) &&
         std::bit_floor(T(6)) == T(4) && std::bit_floor(T(7)) == T(4) &&
         std::bit_floor(T(8)) == T(8) && std::bit_floor(T(9)) == T(8);
}
