...
void test() {
  static_assert(std::numeric_limits<T>::min_exponent10 == expected,
                "min_exponent10 test 1");
  static_assert(std::numeric_limits<const T>::min_exponent10 == expected,
                "min_exponent10 test 2");
  static_assert(std::numeric_limits<volatile T>::min_exponent10 == expected,
