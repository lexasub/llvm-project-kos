...
template <bool Disable = NeedWorkaroundForPR31864,
          std::enable_if_t<!Disable>* = nullptr, class LLong = long long,
          class ULLong = unsigned long long>
void checkLongLongTypes() {
  static_assert(std::atomic<LLong>::is_always_lock_free ==
                    (2 == ATOMIC_LLONG_LOCK_FREE),
                "");
  static_assert(std::atomic<ULLong>::is_always_lock_free ==
                    (2 == ATOMIC_LLONG_LOCK_FREE),
                "");
}
...
// parameter.
template <class T>
constexpr size_t getSizeOf() {
  return sizeof(T);
}

template <bool Enable = NeedWorkaroundForPR31864,
          std::enable_if_t<Enable>* = nullptr, class LLong = long long,
          class ULLong = unsigned long long>
void checkLongLongTypes() {
...
#define CHECK_ALWAYS_LOCK_FREE(T)                                              \
  ...
  static_assert(std::atomic<char>::is_always_lock_free ==
                ...
                "");
  static_assert(std::atomic<signed char>::is_always_lock_free ==
                    (2 == ATOMIC_CHAR_LOCK_FREE),
                "");
  static_assert(std::atomic<unsigned char>::is_always_lock_free ==
                ...
                "");
#if TEST_STD_VER > 17 && defined(__cpp_char8_t)
  static_assert(std::atomic<char8_t>::is_always_lock_free ==
                    (2 == ATOMIC_CHAR8_T_LOCK_FREE),
                "");
#endif
  static_assert(std::atomic<char16_t>::is_always_lock_free ==
                    (2 == ATOMIC_CHAR16_T_LOCK_FREE),
                "");
  static_assert(std::atomic<char32_t>::is_always_lock_free ==
                    (2 == ATOMIC_CHAR32_T_LOCK_FREE),
                "");
  static_assert(std::atomic<wchar_t>::is_always_lock_free ==
                    (2 == ATOMIC_WCHAR_T_LOCK_FREE),
                "");
  static_assert(std::atomic<short>::is_always_lock_free ==
                    (2 == ATOMIC_SHORT_LOCK_FREE),
                "");
  static_assert(std::atomic<unsigned short>::is_always_lock_free ==
                    (2 == ATOMIC_SHORT_LOCK_FREE),
                "");
  static_assert(
      std::atomic<int>::is_always_lock_free == (2 == ATOMIC_INT_LOCK_FREE), "");
  ...
  static_assert(std::atomic<void*>::is_always_lock_free ==
                ...
                "");
  static_assert(std::atomic<std::nullptr_t>::is_always_lock_free ==
                    (2 == ATOMIC_POINTER_LOCK_FREE),
                "");
