...
void test_cast_return_type() {
  ...
  static_assert(std::is_same<decltype(any_cast<int&>(a)), int&>::value, "");
  static_assert(
      std::is_same<decltype(any_cast<int const&>(a)), int const&>::value, "");
  ...
  static_assert(std::is_same<decltype(any_cast<int>(std::move(a))), int>::value,
                "");
  static_assert(
      std::is_same<decltype(any_cast<int const>(std::move(a))), int>::value,
      "");
  static_assert(
      std::is_same<decltype(any_cast<int&>(std::move(a))), int&>::value, "");
  static_assert(std::is_same<decltype(any_cast<int const&>(std::move(a))),
                             int const&>::value,
                "");
  ...
  static_assert(std::is_same<decltype(any_cast<int const>(ca)), int>::value,
                "");
  static_assert(
      std::is_same<decltype(any_cast<int const&>(ca)), int const&>::value, "");
...
void checkThrows(any& a) {
  ...
  try {
    using RefType =
        typename std::conditional<std::is_lvalue_reference<Type>::value,
