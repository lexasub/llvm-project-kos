...
int main(int, char**) {
  ...
  static_assert(
      testComparisons2(
          year_month_weekday_last{year{1234}, January, weekday_last{Tuesday}},
          year_month_weekday_last{year{1234}, February,
  ...
  for (unsigned i = 1; i < 28; ++i)
    for (unsigned j = 1; j < 28; ++j)
      assert(
          (testComparisons2(year_month_weekday_last{year{1234}, January,
                                                    weekday_last{weekday{i}}},
                            year_month_weekday_last{year{1234}, January,
                                                    weekday_last{weekday{j}}},
                            i == j)));
