...
int main(int, char**) {
  ...
  static_assert(testComparisons6(year_month_day{year{1234}, January, day{1}},
  ...
  static_assert(testComparisons6(year_month_day{year{1234}, January, day{2}},
                                 year_month_day{year{1234}, February, day{1}},
                                 false, true),
                "");

  //  different year and month
  static_assert(testComparisons6(year_month_day{year{1234}, February, day{1}},
                                 year_month_day{year{1235}, January, day{1}},
                                 false, true),
                "");
  ...
  static_assert(testComparisons6(year_month_day{year{1234}, February, day{2}},
                                 year_month_day{year{1235}, January, day{1}},
                                 false, true),
                "");
  ...
  for (unsigned i = 1; i < 28; ++i)
    for (unsigned j = 1; j < 28; ++j)
      assert((testComparisons6(year_month_day{year{1234}, January, day{i}},
  ...
  for (unsigned i = 1; i < 12; ++i)
    for (unsigned j = 1; j < 12; ++j)
      assert((testComparisons6(year_month_day{year{1234}, month{i}, day{12}},
  ...
  for (int i = 1000; i < 20; ++i)
    for (int j = 1000; j < 20; ++j)
      assert((testComparisons6(year_month_day{year{i}, January, day{12}},
