...
constexpr bool testConstexprYears() {
  std::chrono::year_month_weekday ym0{
      std::chrono::year{1234}, std::chrono::January,
      std::chrono::weekday_indexed{std::chrono::Tuesday, 1}};
  std::chrono::year_month_weekday ym1 = ym0 - std::chrono::years{10};
  return ym1.year() == std::chrono::year{1234 - 10} &&
         ym1.month() == std::chrono::January &&
         ym1.weekday() == std::chrono::Tuesday && ym1.index() == 1;
}

constexpr bool testConstexprMonths() {
  std::chrono::year_month_weekday ym0{
      std::chrono::year{1234}, std::chrono::November,
      std::chrono::weekday_indexed{std::chrono::Tuesday, 1}};
  std::chrono::year_month_weekday ym1 = ym0 - std::chrono::months{6};
  return ym1.year() == std::chrono::year{1234} &&
