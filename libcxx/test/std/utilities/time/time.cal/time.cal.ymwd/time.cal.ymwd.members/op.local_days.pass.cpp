...
int main(int, char**) {
...

  {
    constexpr year_month_weekday ymwd{
        year{1970}, month{1}, weekday_indexed{std::chrono::Thursday, 1}};
  ...
  {
    constexpr year_month_weekday ymwd{
        year{2000}, month{2}, weekday_indexed{std::chrono::Wednesday, 1}};
    constexpr local_days sd{ymwd};
  ...
  {
    constexpr year_month_weekday ymwd{year{1940}, month{1},
                                      weekday_indexed{std::chrono::Tuesday, 1}};
    constexpr local_days sd{ymwd};
...

  {
    year_month_weekday ymwd{year{1939}, month{11},
                            weekday_indexed{std::chrono::Wednesday, 5}};
    local_days sd{ymwd};
