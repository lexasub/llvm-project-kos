...
void test(const FromDuration& df, const ToDuration& d) {
...
int main(int, char**) {
  ...
  test(std::chrono::milliseconds(7265000),
       std::chrono::microseconds(7265000000LL));
  test(std::chrono::milliseconds(7265000),
       std::chrono::nanoseconds(7265000000000LL));
  test(std::chrono::milliseconds(7265000),
...
#if TEST_STD_VER > 11
  {
    ...
    test_constexpr<std::chrono::milliseconds, 7265000, std::chrono::minutes,
                   121>();
    test_constexpr<std::chrono::milliseconds, 7265000, std::chrono::seconds,
                   7265>();
    test_constexpr<std::chrono::milliseconds, 7265000,
                   std::chrono::milliseconds, 7265000>();
    test_constexpr<std::chrono::milliseconds, 7265000,
                   std::chrono::microseconds, 7265000000LL>();
    test_constexpr<std::chrono::milliseconds, 7265000, std::chrono::nanoseconds,
                   7265000000000LL>();
