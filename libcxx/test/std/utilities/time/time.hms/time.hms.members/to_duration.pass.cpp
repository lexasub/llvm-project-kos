...
constexpr long long check_duration(Duration d) {
  ...
  ASSERT_SAME_TYPE(typename HMS::precision,
                   decltype(std::declval<HMS>().to_duration()));
...
int main(int, char**) {
  ...
  assert(check_duration(std::chrono::milliseconds(-123456789LL)) ==
         -123456789LL);
  assert(check_duration(std::chrono::microseconds(123456789LL)) == 123456789LL);
  assert(check_duration(std::chrono::microseconds(-123456789LL)) ==
         -123456789LL);
  assert(check_duration(std::chrono::nanoseconds(123456789LL)) == 123456789LL);
  assert(check_duration(std::chrono::nanoseconds(-123456789LL)) ==
         -123456789LL);
