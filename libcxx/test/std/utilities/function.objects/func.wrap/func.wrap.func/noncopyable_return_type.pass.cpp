...
void const_test() {
  ...
  std::function<const NonCopyable(int)> f2b =
      +[](int) { return NonCopyable(); };
...
void member_pointer_test() {
  ...
  static_assert(
      std::is_convertible_v<NonCopyable (LargeLambda::*)(),
                            std::function<NonCopyable(LargeLambda*)> >);
  static_assert(
      std::is_convertible_v<NonCopyable (LargeLambda::*)(),
                            std::function<NonCopyable(LargeLambda&)> >);
  static_assert(
      std::is_convertible_v<NonCopyable (LargeLambda::*)() const,
                            std::function<NonCopyable(LargeLambda*)> >);
  static_assert(
      std::is_convertible_v<NonCopyable (LargeLambda::*)() const,
                            std::function<NonCopyable(LargeLambda&)> >);
  static_assert(
      std::is_convertible_v<NonCopyable (LargeLambda::*)() const,
                            std::function<NonCopyable(const LargeLambda*)> >);
  static_assert(
      std::is_convertible_v<NonCopyable (LargeLambda::*)() const,
                            std::function<NonCopyable(const LargeLambda&)> >);
  ...
  static_assert(std::is_convertible_v<
                NonCopyable LargeLambda::*,
                std::function<const NonCopyable&(const LargeLambda&)> >);
}
...
void ctad_test() {
  ...
  static_assert(
      std::is_same_v<decltype(f1b), std::function<NonCopyable(int)> >);
  static_assert(
      std::is_same_v<decltype(f2b), std::function<NonCopyable(int)> >);
}
