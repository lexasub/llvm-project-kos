...
#define DECLARE_FUNCTIONS_WITH_QUALS(N, ...)                                   \
  struct f0_##N {                                                              \
    R operator()() __VA_ARGS__ { return {}; }                                  \
  };                                                                           \
  struct f1_##N {                                                              \
    R operator()(A1) __VA_ARGS__ { return {}; }                                \
  };                                                                           \
  struct f2_##N {                                                              \
    R operator()(A1, A2) __VA_ARGS__ { return {}; }                            \
  };                                                                           \
  struct f3_##N {                                                              \
    R operator()(A1, A2, A3) __VA_ARGS__ { return {}; }                        \
  } /**/
