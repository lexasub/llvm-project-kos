...
inline std::vector<std::bitset<1000> > get_test_cases<1000>() {
  ...
  cases.push_back(
      std::bitset<1000>(std::string(999, '0') + std::string(1, '1')));
  cases.push_back(
      std::bitset<1000>(std::string(1, '1') + std::string(999, '0')));
  cases.push_back(std::bitset<1000>(
      std::string(1, '1') + std::string(998, '0') + std::string(1, '1')));
  cases.push_back(std::bitset<1000>(
      std::string(1, '1') + std::string(400, '0') + std::string(99, '1') +
      std::string(499, '0') + std::string(1, '1')));
  cases.push_back(
      std::bitset<1000>(std::string(500, '0') + std::string(500, '1')));
  cases.push_back(std::bitset<1000>(
      std::string(1, '1') + std::string(499, '0') + std::string(500, '1')));
  cases.push_back(
      std::bitset<1000>(std::string(500, '1') + std::string(500, '0')));
  cases.push_back(std::bitset<1000>(
      std::string(500, '1') + std::string(499, '0') + std::string(1, '1')));
