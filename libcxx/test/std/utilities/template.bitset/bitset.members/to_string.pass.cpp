...
void check_equal(std::basic_string<CharT> const& s, std::bitset<N> const& b,
...
void test_to_string() {
  ...
  for (std::size_t c = 0; c != cases.size(); ++c) {
    ...
    {
      std::wstring s =
          v.template to_string<wchar_t, std::char_traits<wchar_t> >();
      check_equal(s, v, L'0', L'1');
    }
    {
    ...
    {
      std::wstring s =
          v.template to_string<wchar_t, std::char_traits<wchar_t> >('0');
      check_equal(s, v, L'0', L'1');
    }
    {
    ...
    {
      std::wstring s = v.template to_string<wchar_t, std::char_traits<wchar_t>,
                                            std::allocator<wchar_t> >('0', '1');
      check_equal(s, v, L'0', L'1');
    }
    {
      std::wstring s =
          v.template to_string<wchar_t, std::char_traits<wchar_t> >('0', '1');
      check_equal(s, v, L'0', L'1');
    }
    {
