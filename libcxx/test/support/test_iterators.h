...
public:
  ...
  template <class U>
  TEST_CONSTEXPR_CXX14 output_iterator(const output_iterator<U>& u)
      : it_(u.it_) {}
...
public:
  ...
  template <class U, class T>
  TEST_CONSTEXPR_CXX14 input_iterator(const input_iterator<U, T>& u)
      : it_(u.it_) {}
  ...
  friend TEST_CONSTEXPR_CXX14 bool operator==(const input_iterator& x,
                                              const input_iterator& y) {
    return x.it_ == y.it_;
  }
  friend TEST_CONSTEXPR_CXX14 bool operator!=(const input_iterator& x,
                                              const input_iterator& y) {
...
public:
  ...
  template <class U>
  TEST_CONSTEXPR_CXX14 forward_iterator(const forward_iterator<U>& u)
      : it_(u.it_) {}
  ...
  friend TEST_CONSTEXPR_CXX14 bool operator==(const forward_iterator& x,
...
inline bool TEST_CONSTEXPR_CXX14 operator==(const forward_iterator<T>& x,
                                            const forward_iterator<U>& y) {
  return x.base() == y.base();
}
...
template <class T, class U>
inline bool TEST_CONSTEXPR_CXX14 operator==(
    const bidirectional_iterator<T>& x, const bidirectional_iterator<U>& y) {
  return x.base() == y.base();
}
...
template <class T, class U>
inline bool TEST_CONSTEXPR_CXX14 operator==(
    const random_access_iterator<T>& x, const random_access_iterator<U>& y) {
  return x.base() == y.base();
}
...
template <class T, class U>
inline bool TEST_CONSTEXPR_CXX14 operator<(const random_access_iterator<T>& x,
...
template <class T, class U>
inline TEST_CONSTEXPR_CXX14 typename std::iterator_traits<T>::difference_type
...
template <class Iter>
inline TEST_CONSTEXPR_CXX14 Iter base(output_iterator<Iter> i) {
  return i.base();
}

template <class Iter>
inline TEST_CONSTEXPR_CXX14 Iter base(input_iterator<Iter> i) {
  return i.base();
}

template <class Iter>
inline TEST_CONSTEXPR_CXX14 Iter base(forward_iterator<Iter> i) {
  return i.base();
}

template <class Iter>
inline TEST_CONSTEXPR_CXX14 Iter base(bidirectional_iterator<Iter> i) {
  return i.base();
}

template <class Iter>
inline TEST_CONSTEXPR_CXX14 Iter base(random_access_iterator<Iter> i) {
  return i.base();
}

template <class Iter> // everything else
inline TEST_CONSTEXPR_CXX14 Iter base(Iter i) {
  return i;
}
...
struct NonThrowingIterator {
  ...
  //  iterator operations
  reference operator*() const TEST_NOEXCEPT { return *current_; }
...
template <typename T>
bool operator==(const NonThrowingIterator<T>& a,
                const NonThrowingIterator<T>& b) TEST_NOEXCEPT {
  return a.operator==(b);
}
