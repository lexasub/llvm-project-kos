...
public:
  ...
  friend bool operator!=(bare_allocator x, bare_allocator y) {
    return !(x == y);
  }
};
...
public:
  ...
  friend bool operator==(no_default_allocator, no_default_allocator) {
    return true;
  }
  friend bool operator!=(no_default_allocator x, no_default_allocator y) {
    return !(x == y);
  }
};
...
public:
  min_pointer() TEST_NOEXCEPT = default;
  TEST_CONSTEXPR_CXX14 min_pointer(std::nullptr_t) TEST_NOEXCEPT
      : ptr_(nullptr) {}
  template <class T,
            class = typename std::enable_if<!std::is_const<T>::value>::type>
  TEST_CONSTEXPR_CXX14 min_pointer(min_pointer<T, ID> p) TEST_NOEXCEPT
      : ptr_(p.ptr_) {}

  TEST_CONSTEXPR_CXX14 explicit operator bool() const {
    return ptr_ != nullptr;
  }

  TEST_CONSTEXPR_CXX14 friend bool operator==(min_pointer x, min_pointer y) {
    return x.ptr_ == y.ptr_;
  }
  TEST_CONSTEXPR_CXX14 friend bool operator!=(min_pointer x, min_pointer y) {
    return !(x == y);
...
public:
  ...
  TEST_CONSTEXPR_CXX14 min_pointer(std::nullptr_t) TEST_NOEXCEPT
      : ptr_(nullptr) {}
  TEST_CONSTEXPR_CXX14 explicit min_pointer(min_pointer<void, ID> p)
      TEST_NOEXCEPT : ptr_(static_cast<T*>(p.ptr_)) {}
  ...
  friend TEST_CONSTEXPR_CXX14 min_pointer operator+(difference_type n,
                                                    min_pointer x) {
    return x + n;
  }
  ...
  friend TEST_CONSTEXPR_CXX14 difference_type operator-(min_pointer x,
                                                        min_pointer y) {
    return x.ptr_ - y.ptr_;
  }

  TEST_CONSTEXPR_CXX14 reference operator[](difference_type n) const {
    return ptr_[n];
  }

  friend TEST_CONSTEXPR_CXX14 bool operator<(min_pointer x, min_pointer y) {
    return x.ptr_ < y.ptr_;
  }
  friend TEST_CONSTEXPR_CXX14 bool operator>(min_pointer x, min_pointer y) {
    return y < x;
  ...
  static TEST_CONSTEXPR_CXX14 min_pointer pointer_to(T& t) {
...
public:
  ...
  TEST_CONSTEXPR_CXX14 explicit min_pointer(min_pointer<const void, ID> p)
  ...
  static TEST_CONSTEXPR_CXX14 min_pointer pointer_to(const T& t) {
    return min_pointer(std::addressof(t));
  }
...
template <class T, class ID>
TEST_CONSTEXPR_CXX14 inline bool operator==(min_pointer<T, ID> x,
                                            std::nullptr_t) {
  return !static_cast<bool>(x);
}

template <class T, class ID>
TEST_CONSTEXPR_CXX14 inline bool operator==(std::nullptr_t,
                                            min_pointer<T, ID> x) {
  return !static_cast<bool>(x);
}
...
public:
  ...
  TEST_CONSTEXPR_CXX20 friend bool operator==(min_allocator, min_allocator) {
    return true;
  }
  TEST_CONSTEXPR_CXX20 friend bool operator!=(min_allocator x,
                                              min_allocator y) {
    return !(x == y);
  }
};
...
public:
  ...
  template <class U>
  TEST_CONSTEXPR_CXX20 explicit explicit_allocator(explicit_allocator<U>)
      TEST_NOEXCEPT {}
  ...
  TEST_CONSTEXPR_CXX20 friend bool operator==(explicit_allocator,
                                              explicit_allocator) {
    return true;
  }
  TEST_CONSTEXPR_CXX20 friend bool operator!=(explicit_allocator x,
