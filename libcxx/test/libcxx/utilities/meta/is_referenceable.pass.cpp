...
static_assert(
    (std::__is_referenceable<int __attribute__((__vector_size__(8)))>::value),
    "");
static_assert((std::__is_referenceable<
...
#if TEST_STD_VER >= 11
static_assert(
    (!std::__is_referenceable<void(int, float, Foo&, ...) const>::value), "");
static_assert((!std::__is_referenceable<void(int, float, Foo&, ...) &>::value),
              "");
static_assert(
    (!std::__is_referenceable<void(int, float, Foo&, ...) const&>::value), "");
...
static_assert((std::__is_referenceable<void (Foo::*)(int, float) &>::value),
              "");
static_assert(
    (std::__is_referenceable<void (Foo::*)(int, float) const&>::value), "");
static_assert((std::__is_referenceable<void (Foo::*)(int, float) &&>::value),
              "");
static_assert(
    (std::__is_referenceable<void (Foo::*)(int, float) const&&>::value), "");
...
static_assert((std::__is_referenceable<void (Foo::*)(int, float, Foo&)>::value),
              "");
static_assert(
    (std::__is_referenceable<void (Foo::*)(int, float, Foo&) const>::value),
    "");
#if TEST_STD_VER >= 11
static_assert(
    (std::__is_referenceable<void (Foo::*)(int, float, Foo&) &>::value), "");
static_assert(
    (std::__is_referenceable<void (Foo::*)(int, float, Foo&) const&>::value),
    "");
static_assert(
...
#if TEST_STD_VER >= 11
static_assert(
    (std::__is_referenceable<void (Foo::*)(int, float, ...) &>::value), "");
static_assert(
    (std::__is_referenceable<void (Foo::*)(int, float, ...) const&>::value),
    "");
static_assert(
...
static_assert(
    (std::__is_referenceable<void (Foo::*)(int, float, Foo&, ...)>::value), "");
static_assert((std::__is_referenceable<void (Foo::*)(int, float, Foo&, ...)
                                           const>::value),
              "");
#if TEST_STD_VER >= 11
static_assert(
