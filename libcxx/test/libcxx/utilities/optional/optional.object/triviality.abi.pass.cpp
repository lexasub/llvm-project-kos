...
struct SpecialMemberTest {
  ...
  static_assert(std::is_trivially_copy_assignable_v<O> ==
                ...
                "optional<T> is trivially copy assignable if and only if T is "
           ...
           ((std::is_trivially_move_constructible_v<T> &&
            ...
            ((!std::is_move_constructible_v<T> ||
              !std::is_move_assignable_v<
                  T>)&&std::is_trivially_copy_constructible_v<T> &&
             std::is_trivially_copy_assignable_v<T>))),
      "optional<T> is trivially move assignable if T is trivially "
      "destructible, and either "
...
struct TrivialMoveNonTrivialCopy {
  ...
  TrivialMoveNonTrivialCopy& operator=(const TrivialMoveNonTrivialCopy&) {
    return *this;
  }
