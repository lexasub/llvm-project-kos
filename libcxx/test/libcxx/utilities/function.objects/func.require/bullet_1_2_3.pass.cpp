...
#define F(...)                                                                 \
  R f(__VA_ARGS__) {                                                           \
    return MethodID<R (MemFun03::*)(__VA_ARGS__)>::setUncheckedCall();         \
  }                                                                            \
  R f(__VA_ARGS__) const {                                                     \
    return MethodID<R (MemFun03::*)(__VA_ARGS__) const>::setUncheckedCall();   \
  }                                                                            \
  R f(__VA_ARGS__) volatile {                                                  \
    return MethodID<R (MemFun03::*)(                                           \
        __VA_ARGS__) volatile>::setUncheckedCall();                            \
  }                                                                            \
  R f(__VA_ARGS__) const volatile {                                            \
    return MethodID<R (MemFun03::*)(__VA_ARGS__)                               \
                        const volatile>::setUncheckedCall();                   \
  }
#
  F()
  F(...)
...
#define F(...)                                                                 \
  R f(__VA_ARGS__)& {                                                          \
    return MethodID<R (C::*)(__VA_ARGS__)&>::setUncheckedCall();               \
  }                                                                            \
  R f(__VA_ARGS__) const& {                                                    \
    return MethodID<R (C::*)(__VA_ARGS__) const&>::setUncheckedCall();         \
  }                                                                            \
  R f(__VA_ARGS__) volatile& {                                                 \
    return MethodID<R (C::*)(__VA_ARGS__) volatile&>::setUncheckedCall();      \
  }                                                                            \
  R f(__VA_ARGS__) const volatile& {                                           \
    return MethodID<R (C::*)(__VA_ARGS__)                                      \
                        const volatile&>::setUncheckedCall();                  \
  }                                                                            \
  R f(__VA_ARGS__)&& {                                                         \
    return MethodID<R (C::*)(__VA_ARGS__) &&>::setUncheckedCall();             \
...
int main(int, char**) {
  ...
  TestCase11<R(A&&, A&&, ...)&&, 2, Q_None, /* RValue */ true>::run();
  TestCase11<R(A&&, A&&, ...) const&&, 2, Q_Const, /* RValue */ true>::run();
  TestCase11<R(A&&, A&&, ...) volatile&&, 2, Q_Volatile,
             /* RValue */ true>::run();
  TestCase11<R(A&&, A&&, ...) const volatile&&, 2, Q_CV,
             /* RValue */ true>::run();
  TestCase11<R(A&&, A&&, A &&)&&, 3, Q_None, /* RValue */ true>::run();
  TestCase11<R(A&&, A&&, A &&) const&&, 3, Q_Const, /* RValue */ true>::run();
  TestCase11<R(A&&, A&&, A &&) volatile&&, 3, Q_Volatile,
             /* RValue */ true>::run();
  TestCase11<R(A&&, A&&, A &&) const volatile&&, 3, Q_CV,
             /* RValue */ true>::run();
  TestCase11<R(A&&, A&&, A&&, ...)&&, 3, Q_None, /* RValue */ true>::run();
  TestCase11<R(A&&, A&&, A&&, ...) const&&, 3, Q_Const,
             /* RValue */ true>::run();
  TestCase11<R(A&&, A&&, A&&, ...) volatile&&, 3, Q_Volatile,
             /* RValue */ true>::run();
  TestCase11<R(A&&, A&&, A&&, ...) const volatile&&, 3, Q_CV,
