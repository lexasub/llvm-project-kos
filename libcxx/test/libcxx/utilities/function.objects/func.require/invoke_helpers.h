...
template <class Tp>
std::reference_wrapper<volatile Tp>
makeVolatile(std::reference_wrapper<Tp>& ref) {
...
template <class Tp>
std::reference_wrapper<const volatile Tp>
makeCV(std::reference_wrapper<Tp>& ref) {
...
struct DerefPropType {
  ...
  To volatile&& operator*() volatile&& {
    return static_cast<To volatile&&>(object);
  }
  To const volatile&& operator*() const volatile&& {
    return static_cast<To const volatile&&>(object);
  }
#endif
};
...
private:
  ...
  void runTestImp(Int<0>, MethodPtr ptr, ObjectT& object) {
    {
      static_assert(
          (std::is_same<decltype(std::__invoke(ptr, object_cast(object))),
                        CallRet>::value),
          "");
...
#if TEST_STD_VER >= 11
    {
      static_assert((std::is_same<decltype(std::__invoke_constexpr(
                                      ptr, object_cast(object))),
                                  CallRet>::value),
                    "");
      assert(ID::unchecked_call == false);
  ...
  void runTestImp(Int<1>, MethodPtr ptr, ObjectT& object) {
    {
      static_assert((std::is_same<decltype(std::__invoke(
                                      ptr, object_cast(object), arg_cast(a0))),
                                  CallRet>::value),
                    "");
      assert(ID::unchecked_call == false);
...
#if TEST_STD_VER >= 11
    {
      ...
      assert(ID::unchecked_call == false);
      CallRet ret =
          std::__invoke_constexpr(ptr, object_cast(object), arg_cast(a0));
      assert(ID::checkCalled(ret));
    }
#endif
  }
  ...
  void runTestImp(Int<2>, MethodPtr ptr, ObjectT& object) {
    {
      static_assert(
          (std::is_same<decltype(std::__invoke(ptr, object_cast(object),
                                               arg_cast(a0), arg_cast(a1))),
                        CallRet>::value),
          "");
      assert(ID::unchecked_call == false);
      CallRet ret =
          std::__invoke(ptr, object_cast(object), arg_cast(a0), arg_cast(a1));
      assert(ID::checkCalled(ret));
    }
#if TEST_STD_VER >= 11
    {
  ...
  void runTestImp(Int<3>, MethodPtr ptr, ObjectT& object) {
...
#if TEST_STD_VER >= 11
    {
      static_assert((std::is_same<decltype(std::__invoke_constexpr(
                    ...
                    "");
      assert(ID::unchecked_call == false);
      CallRet ret = std::__invoke_constexpr(
          ptr, object_cast(object), arg_cast(a0), arg_cast(a1), arg_cast(a2));
      assert(ID::checkCalled(ret));
    }
#endif
  }
  ...
  void runTestImp(Int<0>, ObjectT& object) {
    {
      static_assert((std::is_same<decltype(std::__invoke(object_cast(object))),
                                  CallRet>::value),
                    "");
      assert(ID::unchecked_call == false);
    ...
    {
      static_assert(
          (std::is_same<decltype(std::__invoke_constexpr(object_cast(object))),
                        CallRet>::value),
          "");
      assert(ID::unchecked_call == false);
  ...
  void runTestImp(Int<1>, ObjectT& object) {
    ...
    {
      static_assert((std::is_same<decltype(std::__invoke_constexpr(
                                      object_cast(object), arg_cast(a0))),
                                  CallRet>::value),
                    "");
      assert(ID::unchecked_call == false);
  ...
  void runTestImp(Int<2>, ObjectT& object) {
    {
      static_assert(
          (std::is_same<decltype(std::__invoke(object_cast(object),
                                               arg_cast(a0), arg_cast(a1))),
                        CallRet>::value),
          "");
      assert(ID::unchecked_call == false);
      CallRet ret =
          std::__invoke(object_cast(object), arg_cast(a0), arg_cast(a1));
      assert(ID::checkCalled(ret));
    }
#if TEST_STD_VER >= 11
    {
      static_assert(
          (std::is_same<decltype(std::__invoke_constexpr(
                            object_cast(object), arg_cast(a0), arg_cast(a1))),
                        CallRet>::value),
          "");
      assert(ID::unchecked_call == false);
      CallRet ret = std::__invoke_constexpr(object_cast(object), arg_cast(a0),
