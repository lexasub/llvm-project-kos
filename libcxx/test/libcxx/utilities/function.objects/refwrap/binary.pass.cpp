...
class functor3 : public std::unary_function<int, int>,
                 public std::binary_function<char, int, double> {
public:
  typedef float result_type;
};

class functor4 : public std::unary_function<int, int>,
                 public std::binary_function<char, int, double> {
public:
};
...
int main(int, char**) {
  ...
  static_assert((!std::is_base_of<std::binary_function<int, int, float>,
                ...
                "");
  static_assert(
      (std::is_base_of<std::binary_function<int, int, float>,
  ...
  static_assert(
      ...
      "");
  static_assert(
      (!std::is_base_of<std::binary_function<C*, int, float>,
  ...
  static_assert(
      (std::is_base_of<
          std::binary_function<const volatile C*, int, float>,
