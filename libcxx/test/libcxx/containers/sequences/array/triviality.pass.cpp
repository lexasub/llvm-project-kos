...
int main(int, char**) {
  ...
  static_assert(
      std::is_trivially_copyable<std::array<NonTrivialCopy, 0> >::value, "");
  static_assert(
      !std::is_trivially_copyable<std::array<NonTrivialCopy, 1> >::value, "");
  static_assert(
      !std::is_trivially_copyable<std::array<NonTrivialCopy, 2> >::value, "");
  static_assert(
      !std::is_trivially_copyable<std::array<NonTrivialCopy, 3> >::value, "");
