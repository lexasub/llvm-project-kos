...
#define _LIBCPP_ALLOCATOR_TRAITS_HAS_XXX(NAME, PROPERTY)                       \
  ...
  template <class _Tp>                                                         \
  struct NAME<_Tp, typename __void_t<typename _Tp::PROPERTY>::type>            \
      : true_type {}
...
#else
  using type _LIBCPP_NODEBUG_TYPE =
...
#ifdef _LIBCPP_CXX03_LANG
  using type _LIBCPP_NODEBUG_TYPE =
      typename pointer_traits<_Ptr>::template rebind<void>::other;
#else
  using type _LIBCPP_NODEBUG_TYPE =
...
#ifdef _LIBCPP_CXX03_LANG
  using type _LIBCPP_NODEBUG_TYPE =
      typename pointer_traits<_Ptr>::template rebind<const void>::other;
#else
  using type _LIBCPP_NODEBUG_TYPE =
...
_LIBCPP_ALLOCATOR_TRAITS_HAS_XXX(__has_alloc_traits_difference_type,
                                 difference_type);
template <class _Alloc, class _Ptr,
          bool = __has_alloc_traits_difference_type<_Alloc>::value>
...
_LIBCPP_ALLOCATOR_TRAITS_HAS_XXX(__has_propagate_on_container_copy_assignment,
...
_LIBCPP_ALLOCATOR_TRAITS_HAS_XXX(__has_propagate_on_container_move_assignment,
...
struct __propagate_on_container_move_assignment<_Alloc, true> {
  using type _LIBCPP_NODEBUG_TYPE =
      typename _Alloc::propagate_on_container_move_assignment;
};

// __propagate_on_container_swap
_LIBCPP_ALLOCATOR_TRAITS_HAS_XXX(__has_propagate_on_container_swap,
...
struct __propagate_on_container_swap<_Alloc, true> {
  using type _LIBCPP_NODEBUG_TYPE =
      typename _Alloc::propagate_on_container_swap;
};
...
struct __has_rebind_other<
    _Tp, _Up,
    typename __void_t<typename _Tp::template rebind<_Up>::other>::type>
    : true_type {};
...
struct __has_allocate_hint<_Alloc, _SizeType, _ConstVoidPtr,
                           decltype((void)declval<_Alloc>().allocate(
                               declval<_SizeType>(), declval<_ConstVoidPtr>()))>
    : true_type {};
...
struct __has_construct_impl<decltype((void)declval<_Alloc>().construct(
                                declval<_Args>()...)),
...
struct __has_destroy<_Alloc, _Pointer,
                     decltype((void)declval<_Alloc>().destroy(
                         declval<_Pointer>()))> : true_type {};
...
struct _LIBCPP_TEMPLATE_VIS allocator_traits {
  ...
  using propagate_on_container_swap =
      typename __propagate_on_container_swap<allocator_type>::type;
  ...
  template <class _Ap = _Alloc,
            class = _EnableIf<__has_allocate_hint<_Ap, size_type,
                                                  const_void_pointer>::value> >
  _LIBCPP_NODISCARD_AFTER_CXX17
      _LIBCPP_INLINE_VISIBILITY _LIBCPP_CONSTEXPR_AFTER_CXX17 static pointer
  ...
  template <class _Ap = _Alloc, class = void,
            class = _EnableIf<!__has_allocate_hint<_Ap, size_type,
                                                   const_void_pointer>::value> >
  _LIBCPP_NODISCARD_AFTER_CXX17
      _LIBCPP_INLINE_VISIBILITY _LIBCPP_CONSTEXPR_AFTER_CXX17 static pointer
  ...
  template <class _Tp, class... _Args,
            class = _EnableIf<
                __has_construct<allocator_type, _Tp*, _Args...>::value> >
  _LIBCPP_INLINE_VISIBILITY _LIBCPP_CONSTEXPR_AFTER_CXX17 static void
  ...
  template <class _Tp, class... _Args, class = void,
            class = _EnableIf<
                !__has_construct<allocator_type, _Tp*, _Args...>::value> >
  _LIBCPP_INLINE_VISIBILITY _LIBCPP_CONSTEXPR_AFTER_CXX17 static void
  ...
  template <class _Tp,
            class = _EnableIf<__has_destroy<allocator_type, _Tp*>::value> >
  _LIBCPP_INLINE_VISIBILITY _LIBCPP_CONSTEXPR_AFTER_CXX17 static void
  ...
  template <class _Tp, class = void,
            class = _EnableIf<!__has_destroy<allocator_type, _Tp*>::value> >
  _LIBCPP_INLINE_VISIBILITY _LIBCPP_CONSTEXPR_AFTER_CXX17 static void
  destroy(allocator_type&, _Tp* __p) {
#if _LIBCPP_STD_VER > 17
  ...
  template <class _Ap = _Alloc,
            class = _EnableIf<__has_max_size<const _Ap>::value> >
  ...
  template <class _Ap = _Alloc,
            class = _EnableIf<
                __has_select_on_container_copy_construction<const _Ap>::value> >
  _LIBCPP_INLINE_VISIBILITY _LIBCPP_CONSTEXPR_AFTER_CXX17 static allocator_type
  select_on_container_copy_construction(const allocator_type& __a) {
    return __a.select_on_container_copy_construction();
  }
  template <class _Ap = _Alloc, class = void,
            class = _EnableIf<!__has_select_on_container_copy_construction<
                const _Ap>::value> >
  _LIBCPP_INLINE_VISIBILITY _LIBCPP_CONSTEXPR_AFTER_CXX17 static allocator_type
  select_on_container_copy_construction(const allocator_type& __a) {
    return __a;
...
template <class _Alloc>
struct __is_cpp17_move_insertable<
    _Alloc, _EnableIf<!__is_default_allocator<_Alloc>::value &&
                      __has_construct<_Alloc, typename _Alloc::value_type*,
...
struct __is_cpp17_copy_insertable<
    _Alloc,
    _EnableIf<!__is_default_allocator<_Alloc>::value &&
              __has_construct<_Alloc, typename _Alloc::value_type*,
